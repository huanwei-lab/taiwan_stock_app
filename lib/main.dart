...
class _StockListPageState extends State<StockListPage> {
  ...
  static const String _defaultSectorRulesText = '11-17=È£üÂ?/Â°ëÂ?\n'
      '20-24=?ºÈêµ/?ªÂ?\n'
      '25-29=?öË?/?äÂ?È´î\n'
      '58-59=?ëË?';
  ...
  final List<_SectorRule> _sectorRules = <_SectorRule>[
    const _SectorRule(start: 11, end: 17, group: 'È£üÂ?/Â°ëÂ?'),
    const _SectorRule(start: 20, end: 24, group: '?ºÈêµ/?ªÂ?'),
    const _SectorRule(start: 25, end: 29, group: '?öË?/?äÂ?È´?),
    const _SectorRule(start: 58, end: 59, group: '?ëË?'),
  ];
  ...
  static const _StrategyPreset _conservativePreset = _StrategyPreset(
    id: 'conservative',
    label: '‰øùÂ?',
    description: 'È´òÈ??ΩÔ?È´òÂ??ÄÊ™ªÔ?Ë®äË?ËºÉÂ?‰ΩÜÁõ∏Â∞çÁ©©?•„Ä?,
    onlyRising: true,
    maxPrice: 45,
    minVolume: 20000000,
  ...
  static const _StrategyPreset _balancedPreset = _StrategyPreset(
    id: 'balanced',
    label: 'Âπ≥Ë°°',
    description: '?èËÉΩ?áÊº≤ÂπÖÂÖºÈ°ßÔ??©Â?Â§ßÂ??∏Êó•Â∏∏Ê??è„Ä?,
    onlyRising: true,
    maxPrice: 50,
    minVolume: 10000000,
  ...
  static const _StrategyPreset _aggressivePreset = _StrategyPreset(
    id: 'aggressive',
    label: 'Á©çÊ•µ',
    description: '?æÂØ¨Ê¢ù‰ª∂?êÊó©?°‰?Ôºå‰?Ê≥¢Â?È¢®Èö™ËºÉÈ???,
    onlyRising: false,
    maxPrice: 60,
    minVolume: 5000000,
  ...
  static const List<_NewsEventTemplate> _newsEventTemplates =
    ...
    _NewsEventTemplate(
      id: 'war_conflict',
      label: '?∞Áà≠/?∞Á∑£Ë°ùÁ?Ê®°Â?',
      adjustmentSummary: '?æÂØ¨?∏ËÇ°‰ΩÜÈ?‰ΩéÂñÆÁ≠ÜÈ¢®?™Ô??øÂ??®Èù¢Á©∫Á?',
      minScore: 50,
    ...
    _NewsEventTemplate(
      id: 'pandemic',
      label: '?´Ê??áÊ∫´Ê®°Â?',
      adjustmentSummary: '?êÈ??ÅË≥™?ÄÊ™ªÔ?Á∏ÆÂ?ËøΩÂÉπ?áÂ??çÁ©∫??,
      minScore: 72,
    ...
    _NewsEventTemplate(
      id: 'drug_approval',
      label: '?∞Ëó•?∏ÂèØÊ®°Â?',
      adjustmentSummary: '?ÅË®±È°åÊ??°Ê≥¢?ïÔ??âÂ§ß?úÂà©‰∏¶‰??ôÈ¢®??,
      minScore: 55,
    ...
    _NewsEventTemplate(
      id: 'policy_stimulus',
      label: '?øÁ??©Â?Ê®°Â?',
      adjustmentSummary: '?©Â∫¶?êÈ?ËøΩÂÉπÂÆπÂ?ÔºåË??¶È??πÂÖ±?ØÊ?Áæ?,
      minScore: 52,
    ...
    _NewsEventTemplate(
      ...
      label: '?áÊÅØ/?öËÜ®Â£ìÂ?Ê®°Â?',
      adjustmentSummary: 'ËΩâÁÇ∫?≤Â?ÔºåÊä¨È´òÂ??∏Ë??ê‰∫§?ºÈ?Ê™?,
      minScore: 68,
    ...
    _NewsEventTemplate(
      ...
      label: '‰æõÊ??à‰∏≠?∑Ê®°Âº?,
      adjustmentSummary: '?©Â∫¶?≤Â?ÔºåÂÑ™?àÂ§ß?ãÈ?ÊµÅÂ??ßÊ???,
      minScore: 64,
  ...
  String? _coreSelectionParamLabel(String key) {
    return switch (key) {
      'strategy' => '?üÁî®Á≠ñÁï•ÁØ©ÈÅ∏',
      'onlyRising' => '?™Á?‰∏äÊº≤',
      'maxPrice' => '?°ÂÉπ‰∏äÈ?',
      'minVolume' => '?èËÉΩ?ÄÊ™?,
      'minTradeValue' => '?ê‰∫§?ºÈ?Ê™?,
      'enableScoring' => '?üÁî®?ìÂ?',
      'minScore' => '?Ä‰ΩéÂ???,
      'excludeOverheated' => '?íÈô§ËøΩÈ?È¢®Èö™',
      'maxChase' => 'ËøΩÈ?Êº≤Â?‰∏äÈ?',
      'breakoutMode' => 'È£ÜËÇ°Ê®°Â?',
      'eventWindowEnabled' => '‰∫ã‰ª∂Á™óÈ?Êø?,
      'eventWindowDays' => '‰∫ã‰ª∂Á™óÂ§©??,
      'revenueEnabled' => '?üÊî∂?ïËÉΩ?éÊøæ',
      'revenueMin' => '?üÊî∂?ïËÉΩ?ÄÊ™?,
      'earningsEnabled' => 'Ë≤°Â†±È©öÂ??éÊøæ',
      'earningsMin' => 'Ë≤°Â†±È©öÂ??ÄÊ™?,
      'riskRewardEnabled' => 'È¢®Èö™?±ÈÖ¨?éÊøæ',
      'riskRewardMin' => 'È¢®Èö™?±ÈÖ¨ÊØîÈ?Ê™?,
      'breadthEnabled' => 'Â∏ÇÂ†¥ÂØ¨Â∫¶?éÊøæ',
      'breadthMin' => 'Â∏ÇÂ†¥ÂØ¨Â∫¶?ÄÊ™?,
      'sectorCapEnabled' => '?¢Ê•≠?Ü‰∏≠Â∫¶‰???,
      'sectorCap' => '?Æ‰??¢Ê•≠‰∏äÈ?',
      'stopLoss' => '?úÊ?(%)',
      'takeProfit' => '?úÂà©(%)',
      'riskBudget' => '?ÆÁ?È¢®Èö™È°çÂ∫¶',
      'cooldownDays' => '?úÊ??∑ÂçªÂ§©Êï∏',
      'foreignEnabled' => 'Â§ñË?Ê∑®Ë≤∑Ë∂?,
      'foreignMin' => 'Â§ñË??ÄÊ™?,
      'trustEnabled' => '?ï‰ø°Ê∑®Ë≤∑Ë∂?,
      'trustMin' => '?ï‰ø°?ÄÊ™?,
      'dealerEnabled' => '?™Á??ÜÊ∑®Ë≤∑Ë?',
      'dealerMin' => '?™Á??ÜÈ?Ê™?,
      'marginDiffEnabled' => '?çË?È§òÈ?ËÆäÂ?',
      'marginMin' => '?çË??ÄÊ™?,
      _ => null,
    };
  }
  ...
  String _parameterAuditSourceLabel(String source) {
    return switch (source) {
      'filter_sheet_apply' => '?ãÂ?Â•óÁî®Á≠ñÁï•',
      'morning_scan' => '?®Áõ§?ÉÊ?',
      'news_template_apply' => '‰∫ã‰ª∂Ê®°ÊùøÂ•óÁî®',
      'news_template_restore' => '‰∫ã‰ª∂Ê®°Êùø?ÑÂ?',
      'auto_mode_rotation' => '?™Â?Ê®°Â??áÊ?',
      'auto_tune_suggestion_apply' => '?Ω‰∏≠?áËá™?ïË™ø??,
      _ => source,
    };
  }
  ...
  String _parameterAuditHistoryLabel(_ParameterChangeAuditEntry entry) {
    ...
    return '${_formatTimeHHmm(entry.timestamp)} ${_parameterAuditSourceLabel(entry.source)}ÔΩ?changesPreview$more';
  }
  ...
  /// Record or update today?ôs filter?ëdrop statistics.  We replace the entry
  ...
  String _buildWeeklyHitRateSummaryText() {
    ...
    return '?ÄËø?Â§©ÂëΩ‰∏≠Ê?Ë¶ÅÔ?Âº∑Âã¢Ë®äË? ${countBy(_EntrySignalType.strong)} Á≠ÜÔ?1D ?ùÁ? ${winRateText(strong1.win, strong1.total)} / Âπ≥Â? ${strong1.avg.toStringAsFixed(2)}%Ôº?
        'ÔΩúË?ÂØüË???${countBy(_EntrySignalType.watch)} Á≠ÜÔ?1D ?ùÁ? ${winRateText(watch1.win, watch1.total)} / Âπ≥Â? ${watch1.avg.toStringAsFixed(2)}%Ôº?
        'ÔΩúÂπ≥?áÊ??•ÂÄôÈÅ∏ ${avgPredPerDay.toStringAsFixed(1)} Ê™?;
  }
  ...
  List<_AutoTuneSuggestion> _buildAutoTuneSuggestions({
    ...
    if ((strong.length + watch.length) < 12 || predictionDays.length < 5) {
      addSuggestion(
        _AutoTuneSuggestion(
          ...
          title: 'Ê®?ú¨‰∏çË∂≥ÔºöÂ??®‰?ÂÆàÂæÆË™?,
          summary:
              'Ëø?0Â§©Ê®£?¨‰??èÂ?ÔºåÂ??êÈ??ÜÊï∏?áÊ?‰∫§ÂÄºÔ??øÂ??éÊó©?æÂØ¨Â∞éËá¥?úË?Â¢ûÂ???,
      ...
      addSuggestion(
        _AutoTuneSuggestion(
          ...
          title: 'Ê®?ú¨‰∏çË∂≥ÔºöÁ∂≠?ÅÂπ≥Ë°?,
          summary: 'Á∂≠Ê??æË??ÄÊ™ªÔ??àÁ¥ØÁ©çÊõ¥Â§?outcomes ?çÂ??≤‰?Ê≠•Ëá™?ïË™ø?É„Ä?,
    ...
    if (needTighten) {
      addSuggestion(
        _AutoTuneSuggestion(
          id: 'tighten_noise',
          title: '?çÈ?Ë®äÔ??è‰?ÂÆàÔ?',
          summary:
              '?ôÈÅ∏?∏Â?Â§öÊ? 1D ?ùÁ??è‰?ÔºåÂª∫Ë≠∞Ê?È´òÂ????ê‰∫§?º‰∏¶?ç‰?ËøΩÈ?‰∏äÈ???,
    ...
    if (canLoosen) {
      addSuggestion(
        _AutoTuneSuggestion(
          ...
          title: '?êË??ãÔ??èÁ?Ê•µÔ?',
          summary:
              '?ôÈÅ∏?∏Â?Â∞ë‰?Âº∑Âã¢Ë°®ÁèæÁ©©Â?ÔºåÂèØÂæÆÊîæÂØ¨È?Ê™ªÊ??á„ÄåÂ?‰∏ÄÂ§©Ê??∞„ÄçË??ãÁ???,
    ...
    addSuggestion(
      _AutoTuneSuggestion(
        id: 'balanced_default',
        title: 'Âπ≥Ë°°ÂæÆË™øÔºàÈ?Ë®≠Ô?',
        summary:
            '?®Ë??ãÁ??áÂ??áÈ??òË°∑ÔºåÈÅ©?àÂ??ö‰??±Ë?ÂØüÂ?Ê±∫Â??ØÂê¶?πÁÇ∫?¥‰?ÂÆ?Á©çÊ•µ??,
  ...
  Future<void> _applyAutoTuneSuggestion(_AutoTuneSuggestion suggestion) async {
    if (_lockSelectionParameters) {
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Â∑≤È?ÂÆöÈÅ∏?°Â??∏Ô??°Ê?Â•óÁî®?™Â?Ë™øÂ?Âª∫Ë≠∞')),
        );
      }
      return;
    }
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(
          'Â∑≤Â??®„Ä?{suggestion.title}?çÔ??ÜÊï∏ $prevMinScore??_minScoreThreshold?ÅËøΩÈ´?$prevMaxChase%??_maxChaseChangePercent%?ÅÊ?‰∫§ÂÄ?${_formatWithThousandsSeparator(prevMinTradeValue)}??{_formatWithThousandsSeparator(_minTradeValueThreshold)}',
        ),
      ),
    );
  }
  ...
  Future<void> _openAutoTuneSuggestionDialog() async {
    ...
    await showDialog<void>(
      ...
      builder: (dialogContext) {
        return AlertDialog(
          title: const Text('?Ω‰∏≠?áËá™?ïË™ø?ÉÂª∫Ë≠∞Ô??ÄËø?30 Â§©Ô?'),
          content: SizedBox(
            width: 560,
            child: Column(
                ...
                ...suggestions.map(
                  (item) => Card(
                    ...
                    child: ListTile(
                      ...
                      subtitle: Text(
                        '${item.summary}\n?ÜÊï∏ >= ${item.minScore}ÔΩúËøΩÈ´?<= ${item.maxChaseChangePercent}%ÔΩúÊ?‰∫§ÂÄ?>= ${_formatWithThousandsSeparator(item.minTradeValue)}',
                      ),
                      isThreeLine: true,
          ...
          return StatefulBuilder(
            builder: (context, setDialogState) {
              Future<void> copy(String name, String content) async {
                ...
                setDialogState(() {
                  status = 'Â∑≤Ë?Ë£?$nameÔº?{content.split('\n').length - 1} Á≠ÜÔ?';
                });
              }
              ...
              return AlertDialog(
                title: const Text('?ØÂá∫?Ω‰∏≠?áË??ôÔ?CSVÔº?),
                content: SizedBox(
                  width: 520,
                  child: Column(
                    mainAxisSize: MainAxisSize.min,
      ...
      await showDialog<void>(
        ...
        builder: (dialogContext) {
          String report = _dailyCandidateArchive.isEmpty
              ? 'Â∞öÁÑ°ÊØèÊó•?ôÈÅ∏Âø´ÁÖßÔºåË??àËá≥Â∞ëÊõ¥??1 ?ã‰∫§?ìÊó•??
              : '';
          return StatefulBuilder(
            builder: (context, setDialogState) {
              void runReplay() {
                if (_dailyCandidateArchive.isEmpty) {
                  setDialogState(() {
                    report = 'Â∞öÁÑ°ÊØèÊó•?ôÈÅ∏Âø´ÁÖßÔºåË??àËá≥Â∞ëÊõ¥??1 ?ã‰∫§?ìÊó•??;
                  });
                  return;
                }

                final rawCodes = codeController.text
                    .split(RegExp(r'[\s,Ôº?Ôºõ]+'))
                ...
                if (rawCodes.isEmpty) {
                  setDialogState(() {
                    report = 'Ë´ãËº∏?•Ë??ûÁ??ÑÈ??°‰ª£?üÔ??ØÂ?Ê™îÔ?‰ª•ÈÄóË??ÜÈ?Ôº?;
                  });
                  return;
                }
                ...
                if (selectedSnapshots.isEmpty) {
                  setDialogState(() {
                    report = '?ÄËø?$lookbackDays Â§©Ê??âÂèØ?®Âø´?ß„Ä?;
                  });
                  return;
                }

                final lines = <String>[
                  '?ûÁ??Ä?ìÔ??ÄËø?$lookbackDays Â§©Ô?${selectedSnapshots.length} Á≠ÜÂø´?ßÔ?',
                  'Ëº∏ÂÖ•‰ª??Ôº?{rawCodes.join('??)}',
                ];
                ...
                for (final code in rawCodes) {
                  ...
                  lines.add(
                    '$codeÔºöÊ†∏Âø?$coreHits/${selectedSnapshots.length} Â§©„ÄÅÂ?$_topCandidateLimit $limitedHits Â§©„ÄÅÂº∑??$strongHits Â§?
                    '${latestCoreDate == null ? '' : 'ÔΩúÊ?ËøëÊ†∏ÂøÉÂëΩ‰∏?$latestCoreDate'}'
                    '${latestStrongDate == null ? '' : 'ÔΩúÊ?ËøëÂº∑?¢ÂëΩ‰∏?$latestStrongDate'}',
                  );
                }

                lines.add(
                  '?¥È?Ë¶ÜË?ÔºöÊ†∏ÂøÉÂëΩ‰∏?$hitAnyCore/${rawCodes.length} Ê™î„ÄÅÂº∑?¢ÂëΩ‰∏?$hitAnyStrong/${rawCodes.length} Ê™?,
                );
                lines.add('Ë®ªÔ?Ê≠§Â??ãÊ™¢?•„ÄåÊòØ?¶Êõæ?•ÈÅ∏?çÔ?‰∏ç‰ª£Ë°®È??•Â?Êº≤„Ä?);
              ...
              return AlertDialog(
                title: const Text('‰∏äÈÄ±È??°Â??ãÔ??ç‰??•ÊòØ?¶Ê??∞Ô?'),
                content: SizedBox(
                  width: 520,
                  child: Column(
                    mainAxisSize: MainAxisSize.min,
                    ...
                    children: [
                      TextField(
                        ...
                        decoration: const InputDecoration(
                          labelText: 'È£ÜËÇ°‰ª??ÔºàÈÄóË??ÜÈ?Ôº?,
                          hintText: '‰æãÂ? 3017, 2382, 3450',
                        ),
                      ),
                      const SizedBox(height: 8),
                      TextField(
  ...
  void _replaceSectorRulesFromText(String raw) {
    ...
    _sectorRules
      ...
      ..addAll(
        parsed.isEmpty
            ? const <_SectorRule>[
                _SectorRule(start: 11, end: 17, group: 'È£üÂ?/Â°ëÂ?'),
                _SectorRule(start: 20, end: 24, group: '?ºÈêµ/?ªÂ?'),
                _SectorRule(start: 25, end: 29, group: '?öË?/?äÂ?È´?),
                _SectorRule(start: 58, end: 59, group: '?ëË?'),
              ]
            : parsed,
      );
  ...
  Future<void> _refreshNews({bool showFeedback = false}) async {
    try {
      ...
      if (showFeedback) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('?∞Ë??òË?Â∑≤Êõ¥??)),
        );
      }
    } catch (error) {
      if (!mounted) {
      ...
      setState(() {
        _isLoadingNews = false;
        _newsError = '?∞Ë?ËºâÂÖ•Â§±Ê?Ôº?error';
      });
    }
  }
  ...
  Future<void> _handleNewsRiskAutomation(MarketNewsSnapshot snapshot) async {
    ...
    if (isHigh && !wasHigh && mounted) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('?çÂ§ß‰∫ã‰ª∂Ê®°Â?ÔºöÊñ∞?ûÈ¢®?™Â?È´òÔ?Â∑≤Ëá™?ïÂ??õ‰?ÂÆàÁ???),
        ),
      );
    }
  ...
  List<({String tag, int score})> _buildTopicStrengths(
    ...
    final rules = <String, List<String>>{
      'AI': <String>['AI', '‰∫∫Â∑•?∫ÊÖß', '‰º∫Ê???, '?∂Á?', 'ÁÆóÂ?'],
      '‰ΩéË?Ë°õÊ?': <String>['‰ΩéË?', 'Ë°õÊ?', 'Â§™Á©∫', 'Starlink'],
      '?´Ê?': <String>['?´Ê??áÊ∫´', '?´Ê?', 'Á¢∫Ë®∫', '?≥Ê?', 'Â∞ÅÂ?', 'ÊµÅÊ?'],
      '?∞Ëó•?üÊ?': <String>['?∞Ëó•?∏ÂèØ', '?∞Ëó•', '?•Ë?', 'FDA', 'EUA', '?®Â?'],
      'ËªçÂ∑•?∞Á∑£': <String>['Ëªç‰?Ë°ùÁ?', '?∞Áà≠', 'Ë°ùÁ?', 'È£õÂ?', '?∞Á∑£'],
      '?ΩÊ??üÁâ©??: <String>['Ê≤πÂÉπ', 'Â§©ÁÑ∂Ê∞?, '?üÊ≤π', '??, '?üÁâ©??],
      '‰æõÊ???: <String>['‰æõÊ??à‰∏≠??, '?∑È?', 'Â°ûÊ∏Ø', 'Áº∫Ë≤®', '?úÂ∑•'],
      '?øÁ??©Á?': <String>['?øÁ?ÂØ¨È?', '?©Á?Á∑äÁ∏Æ', '?áÊÅØ', '?çÊÅØ', '?öËÜ®Â£ìÂ?'],
    };
  ...
  List<String> _topicBeneficiaryHints(
    ...
    final map = <String, String>{
      'AI': '?ØÂÑ™?àÈ?Ê≥®Ô?‰º∫Ê??®„ÄÅÊï£?±„ÄÅÈõªÊ∫ê„ÄÅÈ??üÂÇ≥Ëº?PCB',
      '‰ΩéË?Ë°õÊ?': '?ØÂÑ™?àÈ?Ê≥®Ô?Ë°õÊ??öË??ÅÂ§©Á∑ö„ÄÅÁ∂≤?öË®≠?ô„ÄÅÂú∞?¢Á?‰æõÊ???,
      '?´Ê?': '?ØÂÑ™?àÈ?Ê≥®Ô??≤Áñ´?óÊ??ÅÊ™¢Ê∏¨„ÄÅÁ??ÄË£ΩËó•?ÅÈÜ´?ÇÈÄöË∑Ø',
      '?∞Ëó•?üÊ?': '?ØÂÑ™?àÈ?Ê≥®Ô??∞Ëó•?àÊ??ÅCDMO?ÅËá®Â∫äÂ?Ë®óÊ???,
      'ËªçÂ∑•?∞Á∑£': '?ØÂÑ™?àÈ?Ê≥®Ô?ËªçÂ∑•?∂Á?‰ª∂„ÄÅÂ??ß„ÄÅË?ÂÆâ„ÄÅËÉΩÊ∫êÊõø‰ª?,
      '?ΩÊ??üÁâ©??: '?ØÂÑ™?àÈ?Ê≥®Ô?Ê≤πÊ∞£/?ªÂ?Ë®≠Â??ÅÂ??©Ê?‰∏äÊ∏∏?ÅÁ???,
      '‰æõÊ???: '?ØÂÑ™?àÈ?Ê≥®Ô??ø‰ª£‰æõÊ??à„ÄÅÂú®?∞Â??üÁî¢?ÅÁâ©ÊµÅËà™??,
      '?øÁ??©Á?': '?ØÂÑ™?àÈ?Ê≥®Ô??óÊ??øÁ?Ë£úÂä©?èÁæ§?Å‰?Ë≤†ÂÇµ?êÈï∑?°„ÄÅÈ???,
    };
    ...
    return strengths
        ...
        .take(3)
        .map((item) =>
            '${item.tag}Ôº?{item.score}ÔºâÔ?${map[item.tag] ?? '?ôÊ??èÂÉπ?áÁ?Á¢ºÂ?Ê≠?}')
        .toList();
  }
  ...
  Future<void> _maybeNotifyTopicRotation(MarketNewsSnapshot snapshot) async {
    ...
    if (previousTag != null &&
      ...
      await NotificationService.showAlert(
        id: 4801,
        title: 'Ë≠∞È?Ëº™Â??êÈ?',
        body: 'Â∏ÇÂ†¥‰∏ªÈ???$previousTag ?áÊ???${top.tag}ÔºàÂº∑Â∫?${top.score}Ôº?,
      );
  ...
  String? _autoRiskAdjustmentSuppressedReason() {
    if (_isEventTemplateLayerActive()) {
      return '‰∫ã‰ª∂Ê®°Êùø?•ÁÆ°‰∏≠Ô??™Â??ºÊñ∞?û‰?ÂÆàË??™Â?ÂæÆË™øÔº?;
    }
    if (_isHighNewsRiskDefenseActive) {
      return '?∞Ë?È´òÈ¢®?™‰?ÂÆàÊ®°ÂºèÊé•ÁÆ°‰∏≠ÔºàÂÑ™?àÊñº?™Â?ÂæÆË™øÔº?;
    }
    return null;
  }
  ...
  String _currentControlLayerLabel() {
    if (_isEventTemplateLayerActive()) {
      return '?ßÂà∂Â±§Ô?‰∫ã‰ª∂Ê®°Êùø';
    }
    if (_isHighNewsRiskDefenseActive) {
      return '?ßÂà∂Â±§Ô??∞Ë?‰øùÂ?';
    }
    if (_enableAutoRiskAdjustment) {
      return '?ßÂà∂Â±§Ô??™Â?ÂæÆË™ø';
    }
    return '?ßÂà∂Â±§Ô??∫Â??ÉÊï∏';
  }
  ...
  Future<void> _notifyHoldingExitSignals(List<StockModel> stocks) async {
    ...
    for (final code in _positionLotsByCode.keys) {
      ...
      final pnlText = pnlPercent == null
          ? ''
          : 'ÔΩúÊ???${pnlPercent >= 0 ? '+' : ''}${pnlPercent.toStringAsFixed(2)}%';
      await NotificationService.showAlert(
        id: 3000 + code.hashCode.abs() % 900,
        title: '?ÅËÇ°?∫Â†¥?êÈ? ${stock.code} ${stock.name}',
        body:
            '${signal.label}ÔΩúÁèæ??${stock.closePrice.toStringAsFixed(2)}$pnlText',
      );
  ...
  Future<void> _notifyHoldingModeTagChanges(List<StockModel> stocks) async {
    ...
    for (final code in _positionLotsByCode.keys) {
      ...
      if (previous != null &&
          ...
          currentState != 'strong') {
        final nextText = labels.isEmpty ? '?°ÂëΩ‰∏? : labels.take(3).join('??);
        final previousLabels = _labelsFromFingerprint(previous);
        final previousText =
            previousLabels.isEmpty ? '?°ÂëΩ‰∏? : previousLabels.join('??);
        await NotificationService.showAlert(
          id: 4200 + code.hashCode.abs() % 700,
          title: '?ÅËÇ°Ê®°Â?Ê®ôÁ±§ËÆäÊõ¥ ${stock.code} ${stock.name}',
  ...
  Future<void> _refreshStocks({bool showFeedback = true}) async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('?∞ËÇ°Ë≥áÊ?Â∑≤Êõ¥??)),
      );
    } catch (_) {
      if (!mounted || !showFeedback) {
        return;
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('?¥Êñ∞Â§±Ê?ÔºåË?Á®çÂ??çË©¶')),
      );
    }
  }
  ...
  String _googleWebSignInHintText(String? rawError) {
    ...
    if (error.contains('origin_mismatch')) {
      return 'Google ?ªÂÖ•Â§±Ê?Ôºöorigin_mismatch?ÇË???OAuth Web Client ??Authorized JavaScript origins ?†ÂÖ• http://localhost:7357 ??http://127.0.0.1:7357';
    }
    if (error.contains('access_denied') ||
        error.contains('unauthorized') ||
        error.contains('invalid_client')) {
      return 'Google ?ªÂÖ•Ë¢´Ê??ÇË?Á¢∫Ë? OAuth ?åÊ??´Èù¢Â∑≤Â??ê„ÄÅÁõÆ?çÂ∏≥?üÂú®Ê∏¨Ë©¶‰ΩøÁî®?ÖÂ??ÆÂÖßÔºå‰?‰ΩøÁî®Ê≠?¢∫??Web Client ID';
    }
    if (error.contains('popup')) {
      return 'Google ?ªÂÖ•Ë¶ñÁ?Ë¢´ÁÄèË¶Ω?®Èòª?ã„ÄÇË??ÅË®±ÂΩàÂá∫Ë¶ñÁ?ÂæåÂ?Ë©¶‰?Ê¨?;
    }
    return 'Google ?ªÂÖ•?™Â??ê„ÄÇË?Á¢∫Ë?Â∑≤Â???Drive APIÔºå‰? OAuth Web Client Â∑≤Ë®≠ÂÆ?localhost/127.0.0.1 Á∂≤Â?';
  }
  ...
  Future<bool> _backupNowToGoogle({bool showFeedback = true}) async {
    ...
    if (!_googleDriveBackupService.isSupportedPlatform()) {
      if (showFeedback && mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
              content: Text('?ÆÂ??ÖÊîØ??Android / Chrome(Web) Google ?ô‰ªΩ')),
        );
      }
      return false;
    }
    if (!_googleDriveBackupService.isWebClientIdReady()) {
      if (showFeedback && mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
              content: Text(
                  'Web Â∞öÊú™Ë®≠Â? GOOGLE_WEB_CLIENT_IDÔºåË??†‰? --dart-define=GOOGLE_WEB_CLIENT_ID=...')),
        );
      }
      return false;
    }
    ...
    try {
      ...
      if (email == null) {
        _showGoogleSignInNullFeedback(
          fallback: 'Google ?ªÂÖ•?ñÊ?ÔºåÊú™ÂÆåÊ??ô‰ªΩ',
      ...
      if (!success) {
        if (showFeedback && mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(content: Text('Google È©óË?Â§±Ê?ÔºåË??çÊñ∞?ªÂÖ•')),
          );
        }
        return false;
      }
      ...
      if (showFeedback && mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('Â∑≤Â?‰ªΩÂà∞ GoogleÔº?emailÔº?)),
        );
      }
      return true;
    } catch (error) {
      if (showFeedback && mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('?ô‰ªΩÂ§±Ê?Ôº?error')),
        );
      }
      return false;
    } finally {
  ...
  Future<void> _restoreFromGoogleBackup() async {
    ...
    if (!_googleDriveBackupService.isSupportedPlatform()) {
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
              content: Text('?ÆÂ??ÖÊîØ??Android / Chrome(Web) Google ?ÑÂ?')),
        );
      }
      return;
    }
    ...
    try {
      ...
      if (email == null) {
        _showGoogleSignInNullFeedback(
          fallback: 'Google ?ªÂÖ•?ñÊ?ÔºåÊú™?ÑÂ?Ë≥áÊ?',
          showFeedback: true,
        );
        return;
      }
      ...
      if (payload == null) {
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(content: Text('Google ?≤Á´ØÂ∞öÁÑ°?ô‰ªΩÊ™?)),
          );
        }
        return;
      }
      ...
      if (prefsMap is! Map) {
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(content: Text('?ô‰ªΩÊ™îÊ†ºÂºèÈåØË™?)),
          );
        }
        return;
      }
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('Â∑≤Â? Google ?ÑÂ?Ë≥áÊ?Ôº?emailÔº?)),
        );
      }
    } catch (error) {
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('?ÑÂ?Â§±Ê?Ôº?error')),
        );
      }
    } finally {
      if (mounted) {
  ...
  Future<void> _maybeAutoApplyRecommendedMode(
    ...
    if (changed && mounted && showFeedback) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content:
              Text('Â∑≤Ëá™?ïÂ??õÂª∫Ë≠∞Ê®°ÂºèÔ?${BreakoutModeLabel(recommendation.mode)}'),
        ),
      );
    }
  }
  ...
  Future<void> _sendTestNotification() async {
    await NotificationService.showAlert(
      id: 2001,
      title: '?∞ËÇ°?êÈ?Ê∏¨Ë©¶',
      body: '?öÁü•?üËÉΩÊ≠?∏∏Ôºå‰?ÂæåÊ??™Â??®ÈÄÅÂ????úÂà©Ë®äË???,
    );
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(content: Text('Â∑≤ÈÄÅÂá∫Ê∏¨Ë©¶?êÈ?ÔºåË??•Á??öÁü•??)),
    );
  }
  ...
  Future<void> _runMorningScan() async {
    if (_lockSelectionParameters) {
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Â∑≤È?ÂÆöÈÅ∏?°Â??∏Ô??®Áõ§?ÉÊ?‰∏çÊ??πÂ??∏Â?Ê¢ù‰ª∂')),
        );
      }
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(content: Text('?®Áõ§?ÉÊ?ÂÆåÊ?ÔºöÂ∑≤Â•óÁî®Âº∑Âã¢?ôÈÅ∏Ê®°Â?')),
    );
  }
  ...
  Future<void> _openNewsLink(String link) async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(content: Text('?°Ê??¥Êé•?ãÂ?ÔºåÂ∑≤Ë§áË£Ω?∞Ë?????∞Ââ™Ë≤ºÁ∞ø')),
    );
  }
  ...
  Future<void> _applyBacktestTuningResult(BacktestTuningResult? tuning) async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(
          'Â∑≤Â??®Â?Ê∏?Top1Ôº?{tuning.applyStopLoss ? '?úÊ? -${tuning.stopLossPercent}%' : ''}${(tuning.applyStopLoss && tuning.applyTakeProfit) ? ' / ' : ''}${tuning.applyTakeProfit ? '?úÂà© +${tuning.takeProfitPercent}%' : ''}',
        ),
      ),
    );
  }
  ...
  List<String> _buildStrategyConsistencyWarnings() {
    ...
    if (_lockSelectionParameters) {
      warnings.add('?ÆÂ??üÁî®?∏ËÇ°?ÉÊï∏?ñÂ?ÔºöËá™?ïË™ø?¥Â∑≤?´Â?ÔºåÈ??ãÂ?Ëß???çÊ?ËÆäÊõ¥?∏Â?Ê¢ù‰ª∂??);
    }
    if (_marketNewsSnapshot == null) {
      warnings.add('?∞Ë?Âø´ÁÖßÂ∞öÊú™Âª∫Á?Ôºö‰?‰ª?È¢®Èö™?∏È?Ê¢ù‰ª∂?ØËÉΩ?èÂ?‰øùÂ??ñ‰∏≠?ßÂà§ËÆÄ??);
    }

    if (_maxPriceThreshold > 70) {
      warnings.add('?°ÂÉπ‰∏äÈ??èÈ?ÔºåÂèØ?ΩÂ??¢Â?Ë≥á‰??πÁ??•„Ä?);
    }
    if (_minTradeValueThreshold < 500000000) {
      warnings.add('?ê‰∫§?ºÈ?Ê™ªÂ?‰ΩéÔ?ÊµÅÂ??ßÈ¢®?™‰??á„Ä?);
    }
    if (!_excludeOverheated) {
      warnings.add('Â∑≤È??âËøΩÈ´òÈ?ÊøæÔ??≠Á?Ê≥¢Â?È¢®Èö™?êÈ???);
    }
    if (!_onlyRising) {
      warnings.add('?™È??∂Áï∂?•‰?Êº≤Ô??≤Â†¥?ùÁ??ØËÉΩ‰∏ãÈ???);
    }
    if (_stopLossPercent > 8) {
      warnings.add('?úÊ??éÂØ¨ÔºåÂñÆÁ≠ÜÂ??§ÂèØ?ΩÂ?Â§ß„Ä?);
    }
    if (!_requireOpenConfirm) {
      warnings.add('?™Â??®È???0?ÜÈ?Á¢∫Ë?ÔºåËøΩ?πÈ¢®?™Ê?È´ò„Ä?);
    }
    if (_autoRefreshEnabled && _autoRefreshMinutes > 20) {
      warnings.add('?™Â??¥Êñ∞?ìÈ??èÈï∑ÔºåÂèØ?ΩÈåØ?éÁõ§‰∏≠Ë??ñ„Ä?);
    }
    if (!_autoDefensiveOnHighNewsRisk) {
      warnings.add('?çÂ§ß‰∫ã‰ª∂Ê®°Â?Â∑≤È??âÔ?Á™ÅÁôºÊ∂àÊÅØ‰∏ãÈ??ãÂ?Ë™øÊï¥Á≠ñÁï•??);
    }
    if (!_useRelativeVolumeFilter) {
      warnings.add('?™Â??®Áõ∏Â∞çÈ??ΩÈ?Ê™ªÔ?Ë°åÊ?ËΩâÂº±?ÇÂèØ?ΩË™§?ìÈ?Ë®ä„Ä?);
    }
    if (!_enableTrailingStop) {
      warnings.add('?™Â??®Áßª?ïÂ??©Ô?Âº∑Âã¢?°Â??§‰?Ë≠∑Ë?Âº±„Ä?);
    }
    if (_autoLossStreakFromJournal() >= 3) {
      warnings.add('?ÆÂ???ôß?èÈ?ÔºåÁ≥ªÁµ±Ê??™Â??çÂÄâ„Ä?);
    }
    if (!_autoRegimeEnabled) {
      warnings.add('?™Â???Regime ?™Â??áÊ?ÔºåÂ??∏‰??ÉÈö®?§Âã¢Ë™øÊï¥??);
    }
    if (!_timeSegmentTuningEnabled) {
      warnings.add('?™Â??®Ê?ÊÆµÂ??ãÂ??∏Ô??ãÁõ§?úË??üÈò≤Ë≠∑Ë?Âº±„Ä?);
    }
    if (!_enableAdaptiveAtrExit) {
      warnings.add('?™Â???ATR ?™ÈÅ©?âÂ??©Ô??úÂà©?ÄÊ™ªÂ?Ê≥¢Â??§Â?ËºÉÂÉµÁ°¨„Ä?);
    }
    if (!_enableBreakoutQuality) {
      warnings.add('?™Â??®Á??¥Â?Ë≥™È?ÊøæÔ??áÁ??¥Ë??üÂèØ?ΩÂ??†„Ä?);
    }
    if (_breakoutMinVolumeRatioPercent < 120) {
      warnings.add('Á™ÅÁ†¥?èËÉΩ?çÁ??è‰?ÔºåÂª∫Ë≠∞Ëá≥Â∞?120% ‰ª•‰???);
    }
    if (_enableChipConcentrationFilter && _minChipConcentrationPercent > 0) {
      warnings.add('Â∑≤Â??®Á?Á¢ºÈ?‰∏≠Â∫¶?éÊøæÔºå‰???${_minChipConcentrationPercent.toInt()}% ?Ñ‰?È°ØÁ§∫??);
    }
    if (_enableMasterTrapFilter) {
      warnings.add('‰∏ªÂ?Ë™òÂ??éÊøæ?ãÂ?ÔºåË?Âπ?${_masterTrapDropPercent.toInt()}% ?§ÁÇ∫Ë™òÂ?');
    }
    if (!_enableRiskRewardPrefilter) {
      warnings.add('?™Â??®È¢®?™Â†±?¨Â?ÁΩÆÈ?ÊøæÔ?‰ΩéÂ†±?¨Ê?‰∫§Ê??ØËÉΩÂ¢ûÂ???);
    }
    if (_minRiskRewardRatioX100 < 150) {
      warnings.add('?Ä‰ΩéÈ¢®?™Â†±?¨Ê??è‰?ÔºåÂª∫Ë≠∞Ëá≥Â∞?1.50??);
    }
    switch (BreakoutMode) {
      case BreakoutMode.confirmed:
        if (!_enableMultiDayBreakout) {
          warnings.add('Á¢∫Ë?Á™ÅÁ†¥Ê®°Â?‰∏ãÈ??âÈÄ??Á™ÅÁ†¥Á¢∫Ë?ÔºåÂª∫Ë≠∞È??ü‰ª•?ç‰??úË???);
        }
        if (_minBreakoutStreakDays < 2) {
          warnings.add('???Á™ÅÁ†¥Â§©Êï∏?è‰?ÔºåÂª∫Ë≠∞Ëá≥Â∞?2 Â§©„Ä?);
        }
        break;
      case BreakoutMode.lowBaseTheme:
        warnings.add('?ÆÂ??∫‰??∫Ê?È°åÊ?Ê®°Â?ÔºåË??≠È?‰∫ã‰ª∂È¢®Èö™?áÂ??çÊéßÁÆ°„Ä?);
        break;
      case BreakoutMode.pullbackRebreak:
        warnings.add('?ÆÂ??∫Â?Ê™îÂ??ªÊ®°ÂºèÔ?Âª∫Ë≠∞?çÈ?ËßÄÂØüÈ??ΩÊòØ?¶Â?Ê≠•ÊîæÂ§ß„Ä?);
        break;
      case BreakoutMode.squeezeSetup:
        warnings.add('?ÆÂ??∫È?Á∏ÆÊï¥?ÜÂ??¥Ê®°ÂºèÔ?Ë®äË??êÊó©‰ΩÜÈ?Ë®äÂèØ?ΩÂ??†„Ä?);
        break;
      case BreakoutMode.preEventPosition:
        warnings.add('?ÆÂ??∫‰?‰ª∂Â??°‰?Ê®°Â?ÔºåÂ?ÂøÖÊéß?∂ÂñÆÁ≠ÜÈ¢®?™Ë??®‰???);
        break;
      case BreakoutMode.early:
        break;
    }
    if (!_enableFalseBreakoutProtection) {
      warnings.add('?™Â??®Â?Á™ÅÁ†¥?≤Ë≠∑ÔºåËøΩÈ´òÈ¢®?™ÂèØ?Ω‰??á„Ä?);
    }
    if (!_enableMarketBreadthFilter) {
      warnings.add('?™Â??®Â??¥ÂØ¨Â∫¶È?ÊøæÔ?Âº±Â?‰∏≠Ë™§?≤Â†¥Ê©üÁ??êÈ???);
    }
    if ((_minMarketBreadthRatioX100 / 100) < 1.0) {
      warnings.add('Â∏ÇÂ†¥ÂØ¨Â∫¶?ÄÊ™ªÂ?‰ΩéÔ?Âª∫Ë≠∞?≥Â? 1.00??);
    }
    if (!_enableEventRiskExclusion) {
      warnings.add('?™Â??®‰?‰ª∂È¢®?™Ê??§Ô?Ë≤°Â†±/?çË??•Â?ÂæåÊ≥¢?ïÈ??ãÂ?ÁÆ°Á???);
    }
    if (!_enableWeeklyWalkForwardAutoTune) {
      warnings.add('?™Â??®Ê???walk-forward ÂæÆË™øÔºåÂ??∏ÈÅ©?âÁõ§?ãÈÄüÂ∫¶?É‰??ç„Ä?);
    }
    if (_cooldownDays <= 0) {
      warnings.add('?úÊ??∑Âçª?üÁÇ∫ 0 Â§©Ô?????ßÊ?È¢®Èö™?ØËÉΩ‰∏äÂ???);
    }
    if (!_enableSectorRotationBoost) {
      warnings.add('?™Â??®ÊùøÂ°äËº™?ïÂ?Ê¨äÔ??íÂ??ØËÉΩÂøΩÁï•?∂Â?Âº∑ÊùøÂ°ä„Ä?);
    }
  ...
  void _applyNewsEventTemplate(
    ...
    if (_lockSelectionParameters) {
      if (showFeedback && mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Â∑≤È?ÂÆöÈÅ∏?°Â??∏Ô??°Ê?Â•óÁî®‰∫ã‰ª∂Ê®°Êùø')),
        );
      }
      return;
    }
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(
          'Â∑≤Â???{template.label}ÔºöÂ???${prevMinScore}??_minScoreThreshold?ÅÊ?‰∫§ÂÄ?${_formatWithThousandsSeparator(prevMinTradeValue)}??{_formatWithThousandsSeparator(_minTradeValueThreshold)}?ÅËøΩÈ´?${prevMaxChase}%??_maxChaseChangePercent%?ÅÂ???${prevStopLoss}%??_stopLossPercent%?ÅÂ???${prevTakeProfit}%??_takeProfitPercent%?ÅÂñÆÁ≠ÜÈ¢®??${_formatCurrency(prevRiskBudget.toDouble())}??{_formatCurrency(_riskBudgetPerTrade.toDouble())}',
        ),
      ),
    );
  }
  ...
  void _restoreNewsEventTemplate({bool showFeedback = true}) {
    if (_lockSelectionParameters) {
      if (showFeedback && mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Â∑≤È?ÂÆöÈÅ∏?°Â??∏Ô??°Ê??ÑÂ?‰∫ã‰ª∂Ê®°Êùø?ÉÊï∏')),
        );
      }
      return;
    }
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(
          'Â∑≤È??ü‰?‰ª∂Â??ÉÊï∏ÔºöÂ???$_minScoreThreshold?ÅÊ?‰∫§ÂÄ?${_formatWithThousandsSeparator(_minTradeValueThreshold)}?ÅËøΩÈ´ò‰???$_maxChaseChangePercent%?ÅÂ???$_stopLossPercent%?ÅÂ???$_takeProfitPercent%?ÅÂñÆÁ≠ÜÈ¢®??${_formatCurrency(_riskBudgetPerTrade.toDouble())}',
        ),
      ),
    );
  }
  ...
  Future<void> _openKLineChart(StockModel stock) async {
    ...
    await _openExternalUrisWithFallback(
      uris: uris,
      webClipboardHint: '?èË¶Ω?®Èòª?ãÊñ∞?ÜÈ?ÔºåÂ∑≤Ë§áË£Ω CMoney ????∞Ââ™Ë≤ºÁ∞ø',
      fallbackClipboardHint: '?°Ê??¥Êé•?ãÂ?ÔºåÂ∑≤Ë§áË£Ω CMoney ?ôÊè¥????∞Ââ™Ë≤ºÁ∞ø',
    );
  }
  ...
  Future<void> _openCMoneyDiscussion(StockModel stock) async {
    ...
    await _openExternalUrisWithFallback(
      uris: uris,
      webClipboardHint: '?èË¶Ω?®Èòª?ãÊñ∞?ÜÈ?ÔºåÂ∑≤Ë§áË£Ω CMoney Ë®éË?????∞Ââ™Ë≤ºÁ∞ø',
      fallbackClipboardHint: '?°Ê??¥Êé•?ãÂ?ÔºåÂ∑≤Ë§áË£Ω CMoney Ë®éË?????∞Ââ™Ë≤ºÁ∞ø',
    );
  }
  ...
  void _saveCandidatesToFavorites(List<StockModel> stocks) {
    ...
    final message = added > 0 ? 'Â∑≤Êñ∞Â¢?$added Ê™îÂà∞?∂Ë??çÂñÆ' : '?ôÈÅ∏?°ÈÉΩÂ∑≤Âú®?∂Ë??çÂñÆ‰∏?;
  ...
  Future<void> _exportFavoritesText(List<_ScoredStock> rankedStocks) async {
    ...
    if (favorites.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('?ÆÂ?Ê≤íÊ??ØÂåØ?∫Á??∂Ë??°Á•®')),
      );
      return;
    }
    ...
    for (var i = 0; i < favorites.length; i++) {
      ...
      lines.add(
          '   ?í∞ ${stock.closePrice.toStringAsFixed(2)}  $changeEmoji $changePrefix${stock.change.toStringAsFixed(2)}');
      lines.add(
        '   ?ì¶ ??${_formatWithThousandsSeparator(stock.volume)}  ?éØ ??${item.score}${entryPrice == null || pnlPercent == null ? '' : '  ?íº ?êÊú¨ ${entryPrice.toStringAsFixed(2)}'}${lots == null ? '' : '  ÂºµÊï∏ ${lots.toStringAsFixed(lots % 1 == 0 ? 0 : 2)}'}${pnlPercent == null ? '' : '  ?çÁ? ${pnlPercent >= 0 ? '+' : ''}${pnlPercent.toStringAsFixed(2)}%'}${pnlAmount == null ? '' : '  (${pnlAmount >= 0 ? '+' : ''}${_formatCurrency(pnlAmount)})'}',
      );
      lines.add('');
    }

    lines.add('?†Ô? ?Ö‰??îÁ©∂?ÉËÄÉÔ?Ë´ãËá™Ë°åÊéßÁÆ°È¢®?™„Ä?);
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(content: Text('?∂Ë?Ê∏ÖÂñÆÂ∑≤Ë?Ë£ΩÂà∞?™Ë≤ºÁ∞?)),
    );
  }
  ...
  Future<void> _openFilterSheet() async {
    ...
    // fund?ëflow / margin filter locals
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          '?ãÊ?‰ªãÈù¢ÂØÜÂ∫¶Ôº?{_mobileUiDensityLabel(localMobileUiDensity)}',
                        ...
                        Text(
                          '?êÁ§∫ÔºöÁ?ÊπäÂ??®Ê?Ê©üÂØ¨Â∫¶Á??àÔ?< 600Ôºâ„Ä?,
                          style: Theme.of(context).textTheme.bodySmall,
                        ),
                        const SizedBox(height: 8),
                        SwitchListTile(
                          ...
                          title: const Text('?êË®≠Â±ïÈ??°Á?Ë©≥Á¥∞Ë™™Ê?'),
                          onChanged: (value) {
                            setLocalState(() {
                        ...
                        Text(
                          '?ãÊ?Â≠óÁ?Ôº?{_mobileTextScaleLabel(localMobileTextScale)}',
                          style: Theme.of(context).textTheme.titleSmall,
                        ),
                        const SizedBox(height: 6),
                        Wrap(
                        ...
                        Text(
                          '?êÁ§∫ÔºöÂ??®Ê?Ê©üÂØ¨Â∫¶Á??àÔ?< 600Ôºâ„Ä?,
                          style: Theme.of(context).textTheme.bodySmall,
                        ),
                        const SizedBox(height: 8),
                        SwitchListTile(
                          ...
                          title: const Text('?üÁî®Á≠ñÁï•ÁØ©ÈÅ∏'),
                          onChanged: (value) {
                            setLocalState(() {
                        ...
                        SwitchListTile(
                          ...
                          title: const Text('?üÁî®?§‰∏≠?≥Ê??µÊ∏¨ÔºàÊ?5?ÜÈ?Ôº?),
                          subtitle: const Text('App ?®Â??ØÊ?ÊØ??ÜÈ?Ëº™Ë©¢ TWSE ?§‰∏≠Ë≥áÊ?‰∏¶Ë?ÁÆóË???),
                        ...
                        SwitchListTile(
                          ...
                          title: const Text('?ñÂ??∏ËÇ°?ÉÊï∏ÔºàÈò≤?™Â?ÊºÇÁßªÔº?),
                          subtitle: const Text('?üÁî®ÂæåÂ??®Ëá™?ïÁ??•Â???‰∫ã‰ª∂Ê®°Êùø/È´òÈ¢®?™Ëá™?ï‰?ÂÆ?),
                          onChanged: (value) {
                            setLocalState(() {
                        ...
                        SwitchListTile(
                          ...
                          title: const Text('?™Â??áÊ?Âª∫Ë≠∞Ê®°Â?ÔºàÊ??•‰?Ê¨°Ô?'),
                        ...
                        SwitchListTile(
                          ...
                          title: const Text('?™Âú®‰∫§Ê??•Êó©‰∏äËá™?ïÂ???),
                          subtitle: const Text('?±‰??≥ÈÄ±‰? 08:00-10:30 ?çÊ??™Â?Â•óÁî®Âª∫Ë≠∞'),
                          onChanged: (value) {
                            setLocalState(() {
                        ...
                        Text('?™Â??¥Êñ∞?ìÈ?Ôº?{localAutoRefreshMinutes.toInt()} ?ÜÈ?'),
                        Slider(
                        ...
                        SwitchListTile(
                          ...
                          title: const Text('?ãÁõ§30?ÜÈ?Á¢∫Ë??≤Â†¥'),
                          onChanged: (value) {
                            setLocalState(() {
                        ...
                        SwitchListTile(
                          ...
                          title: const Text('?çÂ§ß‰∫ã‰ª∂Ê®°Â?ÔºàÊñ∞?ûÈ?È¢®Èö™?™Â?‰øùÂ?Ôº?),
                          onChanged: localLockSelectionParameters
                              ? null
                              : (value) {
                                  setLocalState(() {
                        ...
                        SwitchListTile(
                          ...
                          title: const Text('‰∫ã‰ª∂Ê®°Êùø?™Â?Â•óÁî®'),
                          subtitle: const Text('?µÊ∏¨?∞Êà∞???´Ê?/?∞Ëó•Á≠â‰?‰ª∂Ê?ÔºåËá™?ïÂ??®Â??âÂ???),
                          onChanged: localLockSelectionParameters
                              ? null
                              : (value) {
                                  setLocalState(() {
                        ...
                        Text(
                          '‰∫ã‰ª∂Ê®°Êùø?™Â??ÑÂ?Â§©Êï∏Ôº?{localAutoRestoreNewsEventTemplateAfterDays.toInt()} Â§©Ô?????°‰?‰ª∂ÂëΩ‰∏≠Â??ÑÂ?Ôº?,
                        ),
                        Slider(
                          ...
                          divisions: 13,
                          label:
                              '${localAutoRestoreNewsEventTemplateAfterDays.toInt()}Â§?,
                          onChanged: (value) {
                            setLocalState(() {
                        ...
                        SwitchListTile(
                          ...
                          title: const Text('Regime ?™Â??áÊ?ÔºàÂ????§Êï¥/?≤Â?Ôº?),
                          onChanged: (value) {
                            setLocalState(() {
                        ...
                        SwitchListTile(
                          ...
                          title: const Text('?ÇÊÆµ?ïÊ??ÉÊï∏ÔºàÈ??§‰?ÂÆàÔ?'),
                          onChanged: (value) {
                            setLocalState(() {
                        ...
                        TextFormField(
                          ...
                          decoration: const InputDecoration(
                            labelText: '?øÂ??ÜÁ?Ë¶èÂ?ÔºàÊ†ºÂºèÔ?11-17=È£üÂ?/Â°ëÂ?Ôº?,
                            helperText: '?ØÂ?Ë°åÔ?‰æãÔ?25-29=?öË?/?äÂ?È´?,
                        ...
                        const SizedBox(height: 8),
                        Text(
                          '?°ÂÉπ‰∏äÈ?Ôº?{_formatWithThousandsSeparator(localMaxPrice.toInt())}',
                        ),
                        Slider(
                          value: localMaxPrice,
                        ...
                        Text(
                          '?ê‰∫§?èÈ?Ê™ªÔ?${_formatWithThousandsSeparator(localVolumeThreshold.toInt())}',
                        ),
                        Slider(
                        ...
                        SwitchListTile(
                          ...
                          title: const Text('?üÁî®?∏Â??èËÉΩ?ÄÊ™?),
                          onChanged: (value) {
                            setLocalState(() {
                        ...
                        Text(
                            '?∏Â??èËÉΩ?ÄÊ™ªÔ?${localRelativeVolumePercent.toInt()}%ÔºàÁõ∏Â∞çÂ§ß?§Âπ≥?áÈ?Ôº?),
                        Slider(
                        ...
                        Text(
                          '?ê‰∫§?ºÈ?Ê™ªÔ?${_formatCurrency(localTradeValueThreshold)}',
                        ),
                        Slider(
                        ...
                        SwitchListTile(
                          ...
                          title: const Text('Â§ñË?Ê∑®Ë≤∑Ë∂ÖÁØ©??),
                          subtitle: Text('?ÄÊ™ªÔ?${_formatWithThousandsSeparator(localMinForeignNet.toInt())}'),
                          onChanged: (value) {
                            setLocalState(() {
                        ...
                        SwitchListTile(
                          ...
                          title: const Text('?ï‰ø°Ê∑®Ë≤∑Ë∂ÖÁØ©??),
                          subtitle: Text('?ÄÊ™ªÔ?${_formatWithThousandsSeparator(localMinTrustNet.toInt())}'),
                          onChanged: (value) {
                            setLocalState(() {
                        ...
                        SwitchListTile(
                          ...
                          title: const Text('?™Á??ÜÊ∑®Ë≤∑Ë?ÁØ©ÈÅ∏'),
                          subtitle: Text('?ÄÊ™ªÔ?${_formatWithThousandsSeparator(localMinDealerNet.toInt())}'),
                          onChanged: (value) {
                            setLocalState(() {
                        ...
                        SwitchListTile(
                          ...
                          title: const Text('?çË?È§òÈ?ËÆäÂ?ÁØ©ÈÅ∏'),
                          subtitle: Text('?ÄÊ™ªÔ?${_formatWithThousandsSeparator(localMinMarginBalanceDiff.toInt())}'),
                          onChanged: (value) {
                            setLocalState(() {
                        ...
                        SwitchListTile(
                          ...
                          title: const Text('?íÈô§ËøΩÈ?È¢®Èö™ÔºàÈ??±Ô?'),
                          onChanged: (value) {
                            setLocalState(() {
                        ...
                        Text('?éÁÜ±Êº≤Â?‰∏äÈ?Ôº?{localMaxChaseChangePercent.toInt()}%'),
                        Slider(
                        ...
                        SwitchListTile(
                          ...
                          title: const Text('Â∫´Â??êÈ??ÖÂê´Ë≠¶Ê?Ë®äË?'),
                          subtitle: const Text('?úÈ?ÂæåÂ??öÁü•?úÊ?/?úÂà©ÔºàË?Â∞ëÈÄöÁü•Ôº?),
                          onChanged: (value) {
                            setLocalState(() {
                        ...
                        SwitchListTile(
                          ...
                          title: const Text('?üÁî®?™Â?Ë™øÂ?ÔºàÈ¢®?™Â??∏Ô?'),
                          subtitle: const Text('‰æùÊñ∞???§Âã¢/ÂØ¨Â∫¶/??ôß?ïÊ?Ë™øÊï¥?ÜÊï∏?ÅÈ??ΩË??úÂà©?ÆÊ?'),
                          onChanged: (value) {
                            setLocalState(() {
                        ...
                        Text(
                          '?™Â?Ë™øÂ?Âº∑Â∫¶Ôº?{localAutoRiskAdjustmentStrength.toInt()}Ôº?{_riskAdjustmentIntensityLabel(localAutoRiskAdjustmentStrength.toInt())}Ôº?,
                        ),
                        Slider(
                        ...
                        Wrap(
                          ...
                          children: [
                            Tooltip(
                              message: '?¥Ê†º?éÊøæÔºöË??üÊõ¥Â∞ë„ÄÅÂ??≤Â???,
                              child: ChoiceChip(
                                label: const Text('‰øùÂ? 25'),
                                selected:
                            ...
                            Tooltip(
                              message: 'Ê®ôÊ?Ë®≠Â?ÔºöÈÄ≤Êîª?áÈ¢®?ßÂπ≥Ë°°„Ä?,
                              child: ChoiceChip(
                                label: const Text('Âπ≥Ë°° 50'),
                                selected:
                                    localAutoRiskAdjustmentStrength.toInt() ==
                                        50,
                                onSelected: (_) {
                            ...
                            Tooltip(
                              message: 'Âø´ÈÄüÂ??âÔ?Ë™øÂ??¥Ê??ü„Ä?,
                              child: ChoiceChip(
                                label: const Text('Á©çÊ•µ 75'),
                                selected:
                                    localAutoRiskAdjustmentStrength.toInt() ==
                                        75,
                                onSelected: (_) {
                        ...
                        SwitchListTile(
                          ...
                          title: const Text('?êË®≠Â±ïÈ?Á©çÊ•µ‰º∞Á?'),
                          onChanged: (value) {
                            setLocalState(() {
                        ...
                        Text('?úÊ?Ë≠¶Á§∫Ôº?${localStopLossPercent.toInt()}%'),
                        Slider(
                        ...
                        Text('?úÂà©Ë≠¶Á§∫Ôº?${localTakeProfitPercent.toInt()}%'),
                        Slider(
                        ...
                        const Divider(height: 24),
                        Text('Ê¨äÈ?Ë®≠Â?Ôº?ÔºùÂøΩ?•Ô?'),
                        Text('?ê‰∫§?èÊ??çÔ?${localVolumeWeight.toInt()}'),
                        Slider(
                        ...
                        Text('Êº≤Ë??æÂ?ÊØîÊ??çÔ?${localChangeWeight.toInt()}'),
                        Slider(
                        ...
                        Text('?°ÂÉπË∑ùÈõ¢Ê¨äÈ?Ôº?{localPriceWeight.toInt()}'),
                        Slider(
                        ...
                        Text('Á±åÁ¢º?Ü‰∏≠Â∫¶Ê??çÔ?${localConcentrationWeight.toInt()}'),
                        Slider(
                        ...
                        Text('?ê‰∫§?ºÊ??çÔ?${localTradeValueWeight.toInt()}'),
                        Slider(
                            ...
                            onPressed: _latestStocks.isEmpty
                                ...
                                : () {
                                    ...
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      SnackBar(
                                          content:
                                              const Text('Ê¨äÈ?Â∑≤Ê†π?öË??üË°®?æËá™?ïË™ø??)),
                                    );
                                  },
                          ),
                        ),
                        Text('ÁßªÂ??úÂà©?ûÊí§Ôº?{localTrailingPullbackPercent.toInt()}%'),
                        Slider(
                        ...
                        SwitchListTile(
                          ...
                          title: const Text('?üÁî® ATR ?™ÈÅ©?âÂ???),
                          onChanged: (value) {
                            setLocalState(() {
                        ...
                        Text(
                            'Á™ÅÁ†¥?èËÉΩ?çÁ??ÄÊ™ªÔ?${localBreakoutMinVolumeRatio.toInt()}%'),
                        Slider(
                        ...
                        SwitchListTile(
                          ...
                          title: const Text('Á±åÁ¢º?Ü‰∏≠Â∫¶È?Êø?),
                          subtitle: Text('?™È°ØÁ§∫È?‰∏≠Â∫¶ ??${localMinChipConcentrationPercent.toInt()}% ?ÑÂÄãËÇ°'),
                          onChanged: (value) {
                            setLocalState(() {
                        ...
                        Text('?Ä‰ΩéÁ?Á¢ºÈ?‰∏≠Â∫¶Ôº?{localMinChipConcentrationPercent.toInt()}%'),
                        Slider(
                        ...
                        SwitchListTile(
                          ...
                          title: const Text('È¢®Èö™?±ÈÖ¨?çÁΩÆ?éÊøæ'),
                          onChanged: (value) {
                            setLocalState(() {
                        ...
                        Text(
                            '?Ä‰ΩéÈ¢®?™Â†±?¨Ê?Ôº?{localMinRiskRewardRatio.toStringAsFixed(2)}'),
                        Slider(
                        ...
                        const SizedBox(height: 6),
                        Text(
                          '?õÁ???Á¢∫Ë?Á™ÅÁ†¥/‰ΩéÂü∫?üÈ????ûÊ??çÊîª/?èÁ∏ÆÂæÖÂô¥/‰∫ã‰ª∂?çÂç°‰ΩçÔ??Ø‰??§Âã¢Âø´ÈÄüÂ??õ„Ä?,
                          style: Theme.of(context).textTheme.bodySmall,
                        ),
                        SwitchListTile(
                          contentPadding: EdgeInsets.zero,
                          value: localEnableMultiDayBreakout,
                          title: const Text('???Á™ÅÁ†¥Á¢∫Ë?'),
                          onChanged: (value) {
                            setLocalState(() {
                        ...
                        Text(
                            '?Ä‰ΩéÈÄ??Á™ÅÁ†¥Â§©Êï∏Ôº?{localMinBreakoutStreakDays.toInt()} Â§?),
                        Slider(
                          value: localMinBreakoutStreakDays,
                          min: 1,
                          max: 5,
                          divisions: 4,
                          label: '${localMinBreakoutStreakDays.toInt()}Â§?,
                          onChanged: (value) {
                            setLocalState(() {
                        ...
                        SwitchListTile(
                          ...
                          title: const Text('Â∏ÇÂ†¥ÂØ¨Â∫¶?éÊøæÔºàÊº≤Ë∑åÂÆ∂?∏Ê?Ôº?),
                          onChanged: (value) {
                            setLocalState(() {
                        ...
                        Text(
                            '?Ä‰ΩéÂ??¥ÂØ¨Â∫¶Ê?Ôº?{localMinMarketBreadthRatio.toStringAsFixed(2)}'),
                        Slider(
                        ...
                        SwitchListTile(
                          ...
                          title: const Text('‰∫ã‰ª∂È¢®Èö™?íÈô§ÔºàË≤°???çË?Ôº?),
                          onChanged: (value) {
                            setLocalState(() {
                        ...
                        Text(
                          '‰øùÂ?ÔºöÈÅø?ã‰?‰ª∂Á?‰∏îË?Ê±ÇË?È´òÂ??ΩÔ?Âπ≥Ë°°ÔºöÊ?Ê∫ñÈ?Ê™ªÔ?Á©çÊ•µÔºöÊîæÂØ¨‰?‰ª∂Á??áÂ??∏È?Ê™ª„Ä?,
                          style: Theme.of(context).textTheme.bodySmall,
                        ),
                        SwitchListTile(
                          contentPadding: EdgeInsets.zero,
                          value: localEnableEventCalendarWindow,
                          title: const Text('Ê≥ïË™™/Ë≤°Â†±‰∫ã‰ª∂Á™óÈ?ÊøæÔ?MVPÔº?),
                          subtitle: const Text('‰∫ã‰ª∂?•Â?ÂæåÂ§©?∏ÂÖß?àÈÅø?ãÔ?‰∫ã‰ª∂?çÂç°‰ΩçÊ®°ÂºèÈô§Â§?),
                          onChanged: (value) {
                            setLocalState(() {
                        ...
                        Text('‰∫ã‰ª∂Á™óÂ§©?∏Ô?¬±${localEventCalendarGuardDays.toInt()} Â§?),
                        Slider(
                          value: localEventCalendarGuardDays,
                          min: 0,
                          max: 3,
                          divisions: 3,
                          label: '¬±${localEventCalendarGuardDays.toInt()}Â§?,
                          onChanged: (value) {
                            setLocalState(() {
                              selectedMvpPresetId = null;
                        ...
                        SwitchListTile(
                          ...
                          title: const Text('?àÁ??∂Â??ΩÈ?ÊøæÔ?MVPÔº?),
                          onChanged: (value) {
                            setLocalState(() {
                              selectedMvpPresetId = null;
                        ...
                        Text(
                            '?Ä‰ΩéÁ??∂Â??ΩÂ??∏Ô?${localMinRevenueMomentumScore.toInt()}Ôº?3 ~ +3Ôº?),
                        Slider(
                        ...
                        SwitchListTile(
                          ...
                          title: const Text('Ë≤°Â†± surprise ?éÊøæÔºàMVPÔº?),
                          onChanged: (value) {
                            setLocalState(() {
                              selectedMvpPresetId = null;
                        ...
                        Text(
                            '?Ä‰ΩéË≤°??surprise ?ÜÊï∏Ôº?{localMinEarningsSurpriseScore.toInt()}Ôº?3 ~ +3Ôº?),
                        Slider(
                        ...
                        SwitchListTile(
                          ...
                          title: const Text('?îÊó•Ë∑≥Á©∫È¢®Èö™?≤Ë≠∑ÔºàÁõ§Âæ?Â§úÈ?Ôº?),
                          onChanged: (value) {
                            setLocalState(() {
                        ...
                        SwitchListTile(
                          ...
                          title: const Text('?¢Ê•≠?Ü‰∏≠Â∫¶‰??êÔ?‰æùÊ??°Ô?'),
                          onChanged: (value) {
                            setLocalState(() {
                        ...
                        Text(
                            '?Æ‰??¢Ê•≠?ÄÂ§öÊ????ôÈÅ∏Ôº?{localMaxHoldingPerSector.toInt()} Ê™?),
                        Slider(
                          value: localMaxHoldingPerSector,
                          min: 1,
                          max: 6,
                          divisions: 5,
                          label: '${localMaxHoldingPerSector.toInt()}Ê™?,
                          onChanged: (value) {
                            setLocalState(() {
                        ...
                        Text('?úÊ??∑Âçª?üÔ?${localCooldownDays.toInt()} Â§?),
                        Slider(
                          value: localCooldownDays,
                          min: 0,
                          max: 7,
                          divisions: 7,
                          label: '${localCooldownDays.toInt()}Â§?,
                          onChanged: (value) {
                            setLocalState(() {
                        ...
                        SwitchListTile(
                          ...
                          title: const Text('?øÂ?Ëº™Â?Âº∑Â∫¶?íÂ?'),
                          onChanged: (value) {
                            setLocalState(() {
                        ...
                        SwitchListTile(
                          ...
                          title: const Text('ÊØèÈÄ±Ëá™??walk-forward ÂæÆË™ø'),
                          onChanged: (value) {
                            setLocalState(() {
                        ...
                        Text(
                            'ATR ?úÂà©?çÊï∏Ôº?{localAtrTakeProfitMultiplier.toInt()}x'),
                        Slider(
                        ...
                        Text('?ÆÂ?????ßÊ?Á≠ÜÊï∏Ôº?{localManualLossStreak.toInt()}'),
                        Slider(
                        ...
                        Text('?Ä‰ΩéÂ??ÄÊ™ªÔ?${localMinScore.toInt()}'),
                        Slider(
                          value: localMinScore,
                        ...
                        Text('?èËÉΩÊ¨äÈ?Ôº?{localVolumeWeight.toInt()}'),
                        Slider(
                        ...
                        Text('Êº≤Â?Ê¨äÈ?Ôº?{localChangeWeight.toInt()}'),
                        Slider(
                        ...
                        Text('‰ΩéÂÉπÊ¨äÈ?Ôº?{localPriceWeight.toInt()}'),
                        Slider(
                        ...
                        Text(
                          '?êÁ§∫ÔºöÂèØ?àÈ??êË®≠ÔºåÂ?ÂæÆË™ø?ÉÊï∏?ÇÂ?ËΩâÂà§?∑‰??ÄÊ≠∑Âè≤Ë≥áÊ?ÔºåÁõÆ?çÁî®?èËÉΩÔºãÊº≤ÂπÖÔ?‰ΩéÂÉπÂª∫Á??ùÊ≠•?ÜÊï∏??,
                          style: Theme.of(context).textTheme.bodySmall,
                        ),
    ...
    final message = _enableStrategyFilter
        ? 'Â∑≤Â??®Á??•Ô??°ÂÉπ <= $_maxPriceThresholdÔºåÈ? ${_useRelativeVolumeFilter ? '>= $_relativeVolumePercent%?áÈ?‰∏? : '>='} ${_formatWithThousandsSeparator(_surgeVolumeThreshold)}ÔºåÂÄ?>= ${_formatCurrency(_minTradeValueThreshold)}${_onlyRising ? 'ÔºåÂè™?ã‰?Êº? : ''}'
        : 'Â∑≤È°ØÁ§∫ÂÖ®?®ËÇ°Á•?;
    ScaffoldMessenger.of(context)
        .showSnackBar(
      SnackBar(
        content: Text(
          attemptedCoreChange ? '$messageÔºàÂ∑≤?ñÂ??∏Â??ÉÊï∏ÔºåÂ?Â•óÁî®?ûÈÅ∏?°Ë®≠ÂÆöÔ?' : message,
        ),
      ),
    );
  }
  ...
  int _effectiveMinScoreThresholdWithSnapshot({
    ...
    // breadth-based adjustment: ?æË≤®ÂØ¨Â∫¶?èÂº±?ÇÊ?È´òÈ?Ê™ªÔ?ÂØ¨Â∫¶Âº∑Ê??æÂØ¨
  ...
  String _regimeLabelOf(_MarketRegime regime) {
    return switch (regime) {
      _MarketRegime.bull => 'Â§öÈ†≠',
      _MarketRegime.range => '?§Êï¥',
      _MarketRegime.defensive => '?≤Â?',
    };
  }
  ...
  Future<void> _openEntryPriceDialog(StockModel stock) async {
    ...
    final result = await showDialog<_PositionInput?>(
      ...
      builder: (context) {
        return AlertDialog(
          title: Text('Ë®≠Â??ÅËÇ° - ${stock.code} ${stock.name}'),
          content: Column(
            mainAxisSize: MainAxisSize.min,
            children: [
              TextField(
    ...
    if (result.clear) {
      ...
      await _savePreferences();
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Â∑≤Ê???${stock.code} ?ÅËÇ°Ë®≠Â?')),
      );
      return;
    }
    ...
    if (entryPrice == null || entryPrice <= 0) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('?êÊú¨ÂøÖÈ?Â§ßÊñº 0')),
      );
      return;
    }
    ...
    if (lots == null || lots <= 0) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('ÂºµÊï∏ÂøÖÈ?Â§ßÊñº 0')),
      );
      return;
    }
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(
          'Â∑≤ÂÑ≤Â≠?${stock.code} ?êÊú¨ ${entryPrice.toStringAsFixed(2)} / ÂºµÊï∏ ${lots.toStringAsFixed(lots % 1 == 0 ? 0 : 2)}',
        ),
      ),
    );
  }
  ...
  Future<void> _openManualHoldingDialog() async {
    ...
    if (code.isEmpty || !RegExp(r'^[0-9A-Z]+$').hasMatch(code)) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('?°Á•®‰ª???ºÂ??ØË™§')),
      );
      return;
    }
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(
          'Â∑≤ÂÑ≤Â≠?$code ?êÊú¨ ${entryPrice.toStringAsFixed(2)} / ÂºµÊï∏ ${lots.toStringAsFixed(lots % 1 == 0 ? 0 : 2)}',
        ),
      ),
    );
  }
  ...
  Future<void> _openTradeRecordDialog(
    ...
    if (entryPrice == null || lots == null || lots <= 0) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Ë´ãÂ?Ë®≠Â??ÅËÇ°?êÊú¨?áÂºµ?∏Â?Ë®òÈ?Âπ≥ÂÄ?)),
      );
      return;
    }
    ...
    final saved = await showDialog<bool>(
      ...
      builder: (context) {
        return StatefulBuilder(
          builder: (context, setDialogState) {
            return AlertDialog(
              title: Text('Ë®òÈ?Âπ≥ÂÄ?- ${stock.code} ${stock.name}'),
              content: Column(
                mainAxisSize: MainAxisSize.min,
                children: [
                  Text('?ÅËÇ°?êÊú¨ ${entryPrice.toStringAsFixed(2)}'),
                  const SizedBox(height: 8),
                  Row(
                    children: [
                      const Text('Á≠ñÁï•Ê®ôÁ±§'),
                  ...
                  TextField(
                    ...
                    keyboardType:
                        const TextInputType.numberWithOptions(decimal: true),
                    decoration: const InputDecoration(labelText: '?∫Â†¥??),
                  ),
                  const SizedBox(height: 8),
                  TextField(
                    controller: lotsController,
                    keyboardType:
                        const TextInputType.numberWithOptions(decimal: true),
                    decoration: const InputDecoration(labelText: 'Âπ≥ÂÄâÂºµ??),
                  ),
                  const SizedBox(height: 8),
                  TextField(
                    controller: reasonController,
                    decoration: const InputDecoration(labelText: 'Âπ≥ÂÄâÂ???),
                  ),
                ],
              ),
              actions: [
    ...
    if (exitPrice == null ||
        ...
        closeLots <= 0) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Âπ≥ÂÄâË??ôÊ†ºÂºèÈåØË™?)),
      );
      return;
    }
    if (closeLots > lots) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
            content: Text(
                'Âπ≥ÂÄâÂºµ?∏‰??ØÂ§ß?ºÁõÆ?çÊ???${lots.toStringAsFixed(lots % 1 == 0 ? 0 : 2)} Âº?)),
      );
      return;
    }
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(
          'Â∑≤Ë??ÑÂπ≥?âÔ?${pnlPercent >= 0 ? '+' : ''}${pnlPercent.toStringAsFixed(2)}%ÔºàÈÄ?ôß $autoStreak Á≠ÜÔ?',
        ),
      ),
    );
  }
  ...
  Future<void> _openTradeJournalPage() async {
    if (_tradeJournalEntries.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('?ÆÂ?Â∞öÁÑ°‰∫§Ê??•Ë?Á¥Ä??)),
      );
      return;
    }
    ...
    return showDialog<_BatchCostResult>(
      ...
      builder: (context) {
        return StatefulBuilder(
          builder: (context, setDialogState) {
            return AlertDialog(
              title: const Text('?ÜÊâπË≤∑ÈÄ≤Ë?ÁÆ?),
              content: Column(
                mainAxisSize: MainAxisSize.min,
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  const Text('ÊØèË?‰∏ÄÁ≠ÜÔ??ºÂ?ÔºöÂÉπ??ÂºµÊï∏'),
                  const SizedBox(height: 6),
                  const Text('‰æãÂ?Ôºö\n48,1\n52,2\n50,0.5'),
                  const SizedBox(height: 12),
                  TextField(
              ...
              actions: [
                ...
                FilledButton(
                  onPressed: () {
                    ...
                    if (parseResult == null) {
                      setDialogState(() {
                        errorText = '?ºÂ??ØË™§ÔºåË?‰ΩøÁî®?åÂÉπ??ÂºµÊï∏?ç‰??ΩÂ§ß??0';
                      });
                      return;
                    }
                    Navigator.of(context).pop(parseResult);
                  },
                  child: const Text('Â•óÁî®ÁµêÊ?'),
                ),
              ],
            );
          },
  ...
  _ExitSignal _evaluateExitSignal(StockModel stock, int score) {
    ...
    if (pnlPercent != null && pnlPercent <= -_stopLossPercent) {
      return _ExitSignal(
        label: '?úÊ?Ë≠¶Á§∫ ${pnlPercent.toStringAsFixed(1)}%',
    ...
    if (pnlPercent != null && pnlPercent >= adaptiveTakeProfit) {
      if (_enableTrailingStop) {
        ...
        if (peak >= adaptiveTakeProfit &&
          ...
          return _ExitSignal(
            label: 'ÁßªÂ??úÂà©?∫Â†¥ ${pullback.toStringAsFixed(1)}%',
            type: _ExitSignalType.profit,
          );
        }
        return _ExitSignal(
          label: 'ÁßªÂ??úÂà©??éß Â≥∞ÂÄ?{peak.toStringAsFixed(1)}%',
          type: _ExitSignalType.hold,
        );
      }
      return _ExitSignal(
        label:
            '?ÜÊâπ?úÂà© +${pnlPercent.toStringAsFixed(1)}%ÔºàÁõÆÊ®?${adaptiveTakeProfit.toStringAsFixed(1)}%Ôº?,
        type: _ExitSignalType.profit,
      );
    }

    if (_excludeOverheated && stock.change >= _maxChaseChangePercent) {
      return const _ExitSignal(label: 'ËøΩÈ?È¢®Èö™', type: _ExitSignalType.caution);
    }

    if (score < _effectiveMinScoreThreshold(stock)) {
      return const _ExitSignal(label: 'ËΩâÂº±ËßÄÂØ?, type: _ExitSignalType.caution);
    }

    if (pnlPercent == null) {
      return const _ExitSignal(
          label: '?™Ê??âÔ??çÂá∫?¥Ô?', type: _ExitSignalType.neutral);
    }

    return const _ExitSignal(label: 'Á∫åÊä±ËßÄÂØ?, type: _ExitSignalType.hold);
  }
  ...
  _EntrySignal _evaluateEntrySignal(StockModel stock, int score) {
    ...
    if (_excludeOverheated && stock.change >= _maxChaseChangePercent) {
      return _commitImmediateEntrySignal(
        stock.code,
        const _EntrySignal(label: '?øÂ?ËøΩÈ?', type: _EntrySignalType.avoid),
      );
    }
    ...
    if (!_passesRiskRewardPrefilter(stock)) {
      return _commitImmediateEntrySignal(
        ...
        _EntrySignal(
          label:
              'È¢®Èö™?±ÈÖ¨‰∏çË∂≥Ôº? ${(_minRiskRewardRatioX100 / 100).toStringAsFixed(2)}Ôº?,
          type: _EntrySignalType.wait,
        ),
      );
    }
    ...
    if (!_passesMarketBreadthFilter()) {
      return _commitImmediateEntrySignal(
        ...
        _EntrySignal(
          label:
              'Â∏ÇÂ†¥ÂØ¨Â∫¶‰∏çË∂≥Ôº? ${(_minMarketBreadthRatioX100 / 100).toStringAsFixed(2)}Ôº?,
          type: _EntrySignalType.wait,
        ),
      );
    }
    ...
    if (score >= strongScoreThreshold &&
      ...
      return _applyEntrySignalHysteresis(
        stock.code,
        const _EntrySignal(label: 'Âº∑Âã¢?≤Â†¥', type: _EntrySignalType.strong),
      );
    }
    ...
    if (score >= effectiveMinScore && stock.change > 0) {
      return _applyEntrySignalHysteresis(
        stock.code,
        const _EntrySignal(label: 'ËßÄÂØüÈÄ≤Â†¥', type: _EntrySignalType.watch),
      );
    }

    return _applyEntrySignalHysteresis(
      stock.code,
      const _EntrySignal(label: 'Á≠âÂ?Ë®äË?', type: _EntrySignalType.wait),
    );
  }
  ...
  String _entrySignalDefaultLabel(_EntrySignalType type) {
    return switch (type) {
      _EntrySignalType.strong => 'Âº∑Âã¢?≤Â†¥',
      _EntrySignalType.watch => 'ËßÄÂØüÈÄ≤Â†¥',
      _EntrySignalType.wait => 'Á≠âÂ?Ë®äË?',
      _EntrySignalType.avoid => '?øÂ?ËøΩÈ?',
      _EntrySignalType.neutral => '?™Â??®ÈÄ≤Â†¥ÁØ©ÈÅ∏',
    };
  }
  ...
  _MarketTimingStatus _buildMarketTimingStatus() {
    ...
    if (minutes < 9 * 60) {
      return const _MarketTimingStatus(
        label: '?§Â?ËßÄÂØ?,
        description: 'Â∞öÊú™?ãÁõ§ÔºåÂ??ãÂÄôÈÅ∏?áÈ¢®?™Á??ü„Ä?,
    ...
    if (minutes < (9 * 60 + 30)) {
      if (_requireOpenConfirm) {
        return const _MarketTimingStatus(
          label: '?ãÁõ§Á¢∫Ë???,
          description: '09:30 ?çÂ?ËßÄÂØüÔ??øÂ?ËøΩÂÉπ??,
      ...
      return const _MarketTimingStatus(
        label: '?ãÁõ§?ùÊÆµ',
        description: 'Â∑≤È???09:30 Á¢∫Ë?ÔºåË??êÈ?È¢®Èö™?èË???,
        type: _MarketTimingType.openConfirm,
      );
    }
    ...
    if (minutes <= (13 * 60 + 30)) {
      return const _MarketTimingStatus(
        label: '?ØÁ¢∫Ë™çÈÄ≤Â†¥',
        description: '?Ø‰?Á≠ñÁï•?áÈ¢®?™Ê?‰ª∂Á¢∫Ë™çÈÄ≤Â†¥??,
    ...
    return const _MarketTimingStatus(
      label: '?∂Áõ§ÂæåÊ™¢Ë¶?,
      description: '?§Â??ØÂ?Ê∏¨Ë?Ë™øÊï¥?éÊó•?ÉÊï∏??,
    ...
    for (final stock in stocks) {
      if (!_passesMasterTrap(stock)) {
        ...
        await NotificationService.showAlert(
          ...
          title: '‰∏ªÂ?Ë™òÂ?Ë≠¶Á§∫ ${stock.code} ${stock.name}',
          body: 'Á±åÁ¢º?Ü‰∏≠Â∫¶ÊÄ•Ë?ÔºåÁèæ??${stock.chipConcentration.toStringAsFixed(1)}%',
        );
  ...
  String _googleBackupStatusLabel() {
    if (!_isGoogleBackupConnected()) {
      return 'Google ?ô‰ªΩÔºöÊú™??é•';
    }
    if (_lastGoogleBackupAt == null) {
      return 'Google ?ô‰ªΩÔºöÂ∑≤??é•ÔºåÂ??™Â?‰ª?;
    }
    if (_isGoogleBackupFreshToday()) {
      return 'Google ?ô‰ªΩÔºö‰??•Â∑≤?ô‰ªΩ ${_lastGoogleBackupAt!.hour.toString().padLeft(2, '0')}:${_lastGoogleBackupAt!.minute.toString().padLeft(2, '0')}';
    }
    return 'Google ?ô‰ªΩÔºöÊ?Ëø?${_formatCompactDateTime(_lastGoogleBackupAt!)}';
  }
  ...
  String _mobileUiDensityLabel(_MobileUiDensity density) {
    return switch (density) {
      _MobileUiDensity.comfortable => '?íÈÅ©',
      _MobileUiDensity.compact => 'Á∑äÊ?',
    };
  }
  ...
  String _mobileTextScaleLabel(_MobileTextScale scale) {
    return switch (scale) {
      _MobileTextScale.small => 'Â∞?,
      _MobileTextScale.medium => '‰∏?,
      _MobileTextScale.large => 'Â§?,
    };
  }
  ...
  List<String> _candidateFilterContextDiffLabels({
    ...
    String? labelFor(String key) {
      return switch (key) {
        ...
        'maxChase' => 'ËøΩÈ?Êº≤Â?‰∏äÈ?',
        'minScore' => '?Ä‰ΩéÂ??∏È?Ê™?,
        'breakoutMode' => 'È£ÜËÇ°ÁØ©ÈÅ∏Ê®°Â?',
        'eventWindowEnabled' => '‰∫ã‰ª∂Á™óÈ?Êø?,
        'eventWindowDays' => '‰∫ã‰ª∂Á™óÂ§©??,
        'revenueEnabled' => '?üÊî∂?ïËÉΩ?éÊøæ',
        'revenueMin' => '?üÊî∂?ïËÉΩ?ÜÊï∏?ÄÊ™?,
        'earningsEnabled' => 'Ë≤°Â†± surprise ?éÊøæ',
        'earningsMin' => 'Ë≤°Â†± surprise ?ÜÊï∏?ÄÊ™?,
        'riskRewardEnabled' => 'È¢®Èö™?±ÈÖ¨?çÁΩÆ?éÊøæ',
        'riskRewardMin' => 'È¢®Èö™?±ÈÖ¨ÊØîÈ?Ê™?,
        'breadthEnabled' => 'Â∏ÇÂ†¥ÂØ¨Â∫¶?éÊøæ',
        'breadthMin' => 'Â∏ÇÂ†¥ÂØ¨Â∫¶?ÄÊ™?,
        'sectorCapEnabled' => '?¢Ê•≠?Ü‰∏≠Â∫¶‰???,
        'sectorCap' => '?Æ‰??¢Ê•≠‰∏äÈ?',
        'concentrationWeight' => 'Á±åÁ¢ºÊ¨äÈ?',
        'tradeValueWeight' => '?ê‰∫§?ºÊ???,
        'enableMasterTrapFilter' => '‰∏ªÂ?Ë™òÂ??éÊøæ',
        'masterTrapDropPercent' => 'Ë™òÂ?Ë∑åÂ??ÄÊ™?,
        _ => null,
      };
    }
  ...
  String _candidateDriftHistoryLabel(_CandidateDriftRecord record) {
    final base =
        '${_formatTimeHHmm(record.timestamp)} ${record.type == 'reset' ? '?∫Ê??çÁΩÆ' : '?çÂñÆËÆäÂ? +${record.addedCount}/-${record.removedCount}'}';
  ...
  Future<void> _restorePreviousCandidateFilterSnapshot() async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(content: Text('Â∑≤È??ü‰?Ê¨°Ê?ËºÉÂ??∏Âø´??)),
    );
  }

  String BreakoutModeLabel(BreakoutMode mode) {
    return switch (mode) {
      BreakoutMode.early => '?õÁ???,
      BreakoutMode.confirmed => 'Á¢∫Ë?Á™ÅÁ†¥',
      BreakoutMode.lowBaseTheme => '‰ΩéÂü∫?üÈ???,
      BreakoutMode.pullbackRebreak => '?ûÊ??çÊîª',
      BreakoutMode.squeezeSetup => '?èÁ∏ÆÂæÖÂô¥',
      BreakoutMode.preEventPosition => '‰∫ã‰ª∂?çÂç°‰Ω?,
    };
  }
  ...
  String _breakoutStageRejectLabel() {
    return switch (BreakoutMode) {
      BreakoutMode.early => 'Â∞öÊú™?≤ÂÖ•?õÁ??¥Â???,
      BreakoutMode.confirmed => '???Á™ÅÁ†¥‰∏çË∂≥Ôº? $_minBreakoutStreakDays Â§©Ô?',
      BreakoutMode.lowBaseTheme => '?™È?‰ΩéÂü∫?üÈ??êÊ?‰ª?,
      BreakoutMode.pullbackRebreak => '?™È??ûÊ??çÊîªÊ¢ù‰ª∂',
      BreakoutMode.squeezeSetup => '?™È??èÁ∏Æ?¥Á?ÂæÖÂô¥Ê¢ù‰ª∂',
      BreakoutMode.preEventPosition => '?™È?‰∫ã‰ª∂?çÂç°‰ΩçÊ?‰ª?,
    };
  }
  ...
  bool _hasEventCatalystNewsSupport(StockModel stock) {
    ...
    final keywords = <String>['Ë≤°Â†±', 'Ê≥ïË™™', '?üÊî∂', '?∞Â?', 'Ë®ÇÂñÆ', 'ËΩâÂñÆ', 'Â±ïÊ?', '?à‰?'];
    for (final item in snapshot.items.take(30)) {
      final title = item.title;
      final hitStock = title.contains(stock.code) || title.contains(stock.name);
  ...
  int? _daysToNearestEventWindow(StockModel stock) {
    ...
    final eventKeywords = <String>['Ê≥ïË™™', 'Ê≥ïË™™??, 'Ë≤°Â†±', 'Ê≥ïË™™?éÊ?', 'Ê•≠Á∏æ?ºË°®'];
  ...
  int _revenueMomentumScore(StockModel stock) {
    ...
    final items = _newsItemsForStock(stock, limit: 20)
        .where((item) => item.title.contains('?üÊî∂'))
        .toList();
    if (items.isEmpty) {
      return 0;
    }
    ...
    for (final item in items) {
      final title = item.title;
      if (title.contains('?ôÂ?') || title.contains('?µÈ?')) {
        score += 2;
      }
      if (title.contains('Âπ¥Ê?') || title.contains('?àÊ?')) {
        score -= 1;
      }
      if (title.contains('Ë°∞ÈÄÄ') || title.contains('‰∏ãÊ?')) {
        score -= 2;
      }

      final yoy = _extractPercentSignal(title, 'Âπ¥Â?');
      final mom = _extractPercentSignal(title, '?àÂ?');
  ...
  int _earningsSurpriseScore(StockModel stock) {
    ...
    final items = _newsItemsForStock(stock, limit: 20)
        .where((item) =>
            item.title.contains('Ë≤°Â†±') ||
            item.title.contains('EPS') ||
            item.title.contains('ÊØèËÇ°?àÈ?') ||
            item.title.contains('Ê≥ïË™™'))
        .toList();
    if (items.isEmpty) {
      return 0;
    }
    ...
    for (final item in items) {
      final title = item.title;
      if (title.contains('?™Êñº?êÊ?') ||
          title.contains('Ë∂ÖÈ???) ||
          title.contains('‰∏ä‰øÆ') ||
          title.contains('ËΩâÁ?')) {
        score += 2;
      }
      if (title.contains('‰ΩéÊñº?êÊ?') ||
          title.contains('‰∏çÂ??êÊ?') ||
          title.contains('‰∏ã‰øÆ') ||
          title.contains('ËΩâËôß') ||
          title.contains('?ßÊ?')) {
        score -= 2;
      }
    }
...
void diagnoseStock(StockModel stock, int score) {
  ...
  bool _passesEventRiskExclusion(StockModel stock) {
    ...
    final riskKeywords = <String>['Ë≤°Â†±', 'Ê≥ïË™™', '?§Ê???, 'Â¢ûË?', 'Ê∏õË?', '?çË?'];
  ...
  _ModeRecommendation _buildModeRecommendationForContext({
    ...
    if (isNightSession) {
      if (newsLevel == NewsRiskLevel.medium ||
        ...
        return _ModeRecommendation(
          ...
          reason: '?ÆÂ??∫Áõ§Âæ?Â§úÈ?Ôºå‰??∞Ë??±Â∫¶ËºÉÈ?ÔºåÂª∫Ë≠∞Áî®‰∫ã‰ª∂?çÂç°‰ΩçÂ??îÊó•ËßÄÂØüÂ??Æ„Ä?,
        );
      }
      if (regime == _MarketRegime.defensive || breadth < 1.0) {
        return _ModeRecommendation(
          ...
          reason:
              '?ÆÂ??∫Áõ§Âæ?Â§úÈ?ÔºåÂ??¥Â?Âº±Ô?ÂØ¨Â∫¶ ${breadth.toStringAsFixed(2)}ÔºâÔ?Âª∫Ë≠∞?à‰ª•?èÁ∏ÆÂæÖÂô¥?ö‰?È¢®Èö™?ôÈÅ∏??,
        );
      }
      return _ModeRecommendation(
        mode: BreakoutMode.confirmed,
        reason: '?ÆÂ??∫Áõ§Âæ?Â§úÈ?ÔºåÂª∫Ë≠∞‰ª•Á¢∫Ë?Á™ÅÁ†¥Ê®°Â?Ë¶èÂ??îÊó•?≤Â†¥ÔºåÈ?‰ΩéÈ?Â§úÈ?Ë®ä„Ä?,
      );
    }
    ...
    if (regime == _MarketRegime.defensive || breadth < 0.95) {
      return _ModeRecommendation(
        mode: BreakoutMode.squeezeSetup,
        reason: '?§Âã¢?èÈò≤ÂÆàÔ?ÂØ¨Â∫¶ ${breadth.toStringAsFixed(2)}ÔºâÔ??àÁî®?èÁ∏ÆÂæÖÂô¥?ç‰?ËøΩÈ?È¢®Èö™??,
      );
    }
    ...
    if (regime == _MarketRegime.bull && breadth >= 1.25) {
      return _ModeRecommendation(
        ...
        reason: '?§Âã¢?èÂ?‰∏îÂØ¨Â∫¶Âº∑Ôº?{breadth.toStringAsFixed(2)}ÔºâÔ??ØÁî®?õÁ??¥Êê∂Á¨¨‰?ÊÆµ„Ä?,
      );
    }
    ...
    if (regime == _MarketRegime.bull && breadth >= 1.05) {
      return _ModeRecommendation(
        ...
        reason: 'Â§öÈ†≠Âª∂Á?‰ΩÜÈ?Ê•µÂº∑ÔºåÂ?Ê™îÂ??ªÂèØ?ºÈ°ß?ùÁ??áÂÖ•?¥Ê??á„Ä?,
      );
    }
    ...
    if (newsLevel == NewsRiskLevel.medium && breadth >= 1.0) {
      return const _ModeRecommendation(
        mode: BreakoutMode.preEventPosition,
        reason: '?∞Ë??±Â∫¶?áÊ∫´‰ΩÜÊú™?∞Ê•µÁ´ØÔ??ØÁî®‰∫ã‰ª∂?çÂç°‰ΩçÂ??âË©¶?Æ„Ä?,
      );
    }
    ...
    if (regime == _MarketRegime.range && breadth >= 1.0) {
      return _ModeRecommendation(
        mode: BreakoutMode.confirmed,
        reason: '?§Êï¥Â∏Ç‰ª•Á¢∫Ë?Á™ÅÁ†¥?éÊøæ?úË?ÔºåÈÅø?çÂ?Á™ÅÁ†¥??,
      );
    }

    return const _ModeRecommendation(
      mode: BreakoutMode.lowBaseTheme,
      reason: 'Ëº™Â??èÂø´?ÇÔ?‰ΩéÂü∫?üÈ??êÊ®°ÂºèÈÄöÂ∏∏ËºÉÂÆπ?ìÊâæ?∞Ë?Êº≤ËÇ°??,
    );
  }
  ...
  Future<void> _maybeRunWeeklyAutoTune(List<StockModel> stocks) async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(
          'ÊØèÈÄ±Ëá™?ïÂæÆË™øÂ??êÔ?${tunedSymbols.join('/')}ÔºâÔ??úÊ? -$tunedStopLoss% / ?úÂà© +$tunedTakeProfit% / ?Ä‰ΩéÂ? $tunedMinScore',
        ),
      ),
    );
  }
    ...
    await showDialog<void>(
      ...
      builder: (context) {
        return StatefulBuilder(
          builder: (context, setDialogState) {
            return AlertDialog(
              title: Text('?®‰?Ë®àÁ? - ${stock.code} ${stock.name}'),
              content: Column(
                mainAxisSize: MainAxisSize.min,
                children: [
                  TextField(
                    ...
                    keyboardType: TextInputType.number,
                    decoration: const InputDecoration(
                      labelText: '?ÆÁ??ÄÂ§ßÂèØ?øÂ??ßÊ?ÔºàÂ?Ôº?,
                    ),
                  ),
                  const SizedBox(height: 8),
                  TextField(
                    ...
                    keyboardType:
                        const TextInputType.numberWithOptions(decimal: true),
                    decoration: const InputDecoration(labelText: '?êË??≤Â†¥??),
                  ),
                  const SizedBox(height: 8),
                  TextField(
                    ...
                    keyboardType:
                        const TextInputType.numberWithOptions(decimal: true),
                    decoration: const InputDecoration(labelText: '?úÊ???),
                  ),
                  const SizedBox(height: 12),
                  ...
                  onPressed: calculatedLots == null || calculatedEntry == null
                      ...
                      : () async {
                          ...
                          ScaffoldMessenger.of(this.context).showSnackBar(
                            SnackBar(
                              content: Text(
                                'Â∑≤Â???${stock.code} ?êÊú¨ ${calculatedEntry!.toStringAsFixed(2)} / ÂºµÊï∏ ${calculatedLots!.toStringAsFixed(calculatedLots! % 1 == 0 ? 0 : 2)}',
                              ),
                            ),
                          );
                        },
                  child: const Text('Â•óÁî®?∞Ê???),
                ),
                FilledButton(
                  onPressed: () {
                    final riskBudget =
                    ...
                    if (lots == null) {
                      setDialogState(() {
                        resultText = '?úÊ??πÈ?Â∞èÊñº?≤Â†¥?πÔ?‰∏îËôß?çÈ?È°çÈ?Â§ßÊñº 0';
                      });
                      return;
                    }
                    ...
                    setDialogState(() {
                      ...
                      resultText =
                          'Âª∫Ë≠∞ÂºµÊï∏ÔºöÁ? $roundedLots ÂºµÔ??ÜÊï∏?â‰? ${tierPercent}%Ôºâ\n?ê‰º∞?ïÂÖ•ÔºöÁ? ${_formatCurrency(positionAmount)}\nÊØèËÇ°È¢®Èö™Ôº?{(entry - stop).toStringAsFixed(2)}\n?∞Ë?‰øÇÊï∏ x${newsRiskMultiplier.toStringAsFixed(2)} ? ??ôß‰øÇÊï∏ x${streakMultiplier.toStringAsFixed(2)} = x${riskMultiplier.toStringAsFixed(2)}ÔºàÂèØ?øÂ??ßÊ? ${_formatCurrency(effectiveRiskBudget)}Ôº?;
                    });
                ...
                children: [
                  ...
                  Text(
                    _googleBackupEmail == null
                        ? '?ÆÂ??™ÈÄ?é• Google Â∏≥Ë?'
                        : 'Â∑≤ÈÄ?é•Ôº?_googleBackupEmail',
                    style: Theme.of(context).textTheme.bodySmall,
                  ),
                  if (_lastGoogleBackupAt != null)
                    Text(
                      '?ÄËøëÂ?‰ªΩÔ?${_lastGoogleBackupAt!.year}-${_lastGoogleBackupAt!.month.toString().padLeft(2, '0')}-${_lastGoogleBackupAt!.day.toString().padLeft(2, '0')} ${_lastGoogleBackupAt!.hour.toString().padLeft(2, '0')}:${_lastGoogleBackupAt!.minute.toString().padLeft(2, '0')}',
                      style: Theme.of(context).textTheme.bodySmall,
                    ),
                  const SizedBox(height: 8),
                  SwitchListTile(
                    ...
                    title: const Text('ÊØèÊó•?™Â??ô‰ªΩÔºàÈ???App ?¥Êñ∞?ÇËß∏?ºÔ?'),
                    onChanged: (value) {
                      setLocalState(() {
                      ...
                      FilledButton.tonalIcon(
                        onPressed: _isGoogleBackupBusy
                            ...
                            : () async {
                                ...
                                await _savePreferences();
                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(content: Text('Â∑≤ÈÄ?é• GoogleÔº?emailÔº?)),
                                );
                              },
                        icon: const Icon(Icons.login),
                        label: const Text('??é• Google'),
                      ),
                      FilledButton.tonalIcon(
                        onPressed: _isGoogleBackupBusy
                            ? null
            ...
            builder: (context, setDialogState) {
              ...
              void runDiagnosis() {
                ...
                final stage = !strategyCodes.contains(matched.code)
                    ...
                    : (!candidateCodes.contains(matched.code)
                        ...
                        : (!qualityCodes.contains(matched.code)
                            ? '?ãÊ?/È¢®Èö™?éÊÆµ'
                            : (inDisplay ? 'Â∑≤Âú®?ÆÂ?Ê∏ÖÂñÆ' : 'ÂæåÁ?Ë¶ñÂ??éÊøæ?éÊÆµ')));
                ...
                if (inDisplay) {
                  ...
                  lines.add('?πÔ? ?ÆÂ??™È°ØÁ§∫Ô?‰ΩÜÁÑ°?éÁ¢∫?íÈô§?üÂ?ÔºàÂèØ?ΩÂ??íÂ?/?êÂà∂ÂΩ±ÈüøÔº?);
                } else {
                  lines.add('?íÈô§?üÂ?Ôº?);
                  ...
                  child: Column(
                    ...
                    children: [
                      TextField(
                        ...
                        decoration: const InputDecoration(
                          labelText: 'Ëº∏ÂÖ•‰ª???ñÂ?Á®±Ô?‰æãÔ?3576 ???ØÂ??çÁ?Ôº?,
                        ),
                      ...
                      if (_searchKeyword.trim().isNotEmpty) ...[
                        ...
                        Align(
                          ...
                          child: TextButton.icon(
                            ...
                            label: Text('Â∏∂ÂÖ•?ÆÂ??úÂ?Ôº?{_searchKeyword.trim()}'),
                          ),
                        ),
                      ],
  ...
  List<String> _buildBullishRationales({
    ...
    String modeNarrative(BreakoutMode mode) {
      return switch (mode) {
        BreakoutMode.early => '?ãÊ??è„ÄåÂ?Á™ÅÁ†¥?çÔ??çÈ??ãÈ??πÊòØ?¶Âª∂Á∫?,
        BreakoutMode.confirmed => '?ãÊ??è„ÄåÁ¢∫Ë™çÁ??¥„ÄçÔ??çÈ??ãÁ??¥Â??ØÂê¶Á´ôÁ©©',
        BreakoutMode.lowBaseTheme => '?ãÊ??è„Äå‰??∫Ê?Ë£úÊº≤?çÔ??öÂ∏∏Â±¨È??êËº™?ïÊé•Ê£?,
        BreakoutMode.pullbackRebreak => '?ãÊ??è„ÄåÂ?Ê™îÂ??ª„ÄçÔ??çÈ??ãÂ?Ê∏¨Â??çÊîæ??,
        BreakoutMode.squeezeSetup => '?ãÊ??è„ÄåÈ?Á∏ÆÂ??¥„ÄçÔ??çÈ??ãÊòØ?¶Êîæ?èËÑ´?¢Áõ§??,
        BreakoutMode.preEventPosition => '?ãÊ??è„Äå‰?‰ª∂Â??°‰??çÔ??çÈ??ã‰?‰ª∂Â?Ë≥áÈ??ØÂê¶?ÅÁ?',
      };
    }

    String sectorNarrative(String value) {
      if (value.contains('?ëË?')) {
        return '?øÂ?Â±¨È??çÔ?Â∏∏Â??©Á?/?øÁ??áÊ??ºË??ëÂ??õÂΩ±??;
      }
      if (value.contains('?ªÂ?') ||
          value.contains('?äÂ?È´?) ||
          value.contains('?öË?')) {
        return '?øÂ?Â±¨Á??Ä?êÈï∑ÔºåÂ∏∏?óAI/‰º∫Ê????ØÊ∞£Âæ™Áí∞Â∏∂Â?';
      }
      if (value.contains('?ºÈêµ')) {
        return '?øÂ?Â±¨ÊôØÊ∞?æ™?∞Ô?Â∏∏Â??±ÂÉπ?áÂ??©Ê??πÊ†ºÂΩ±Èüø';
      }
      if (value.contains('È£üÂ?') || value.contains('Â°ëÂ?')) {
        return '?øÂ??èÊ????üÁâ©?ôÔ?Â∏∏Â??êÊú¨?áÈ?Ê±ÇË??ñÂΩ±??;
      }
      return '?øÂ?Ë≥áÈ??âËº™?ïË∑°Ë±°Ô?Âª∫Ë≠∞?≠È??èÂÉπ?ÅÁ??ßË?ÂØ?;
    }

    final topicNarrativeByTag = <String, String>{
      'AI': 'AI/ÁÆóÂ?È°åÊ??áÊ∫´ÔºåË??ëÂ?Â•Ω‰º∫?çÂô®?áÂ?Â∞éÈ???,
      '‰ΩéË?Ë°õÊ?': '‰ΩéË?Ë°õÊ?È°åÊ??áÊ∫´ÔºåË??ëÂ?Â•ΩÁ∂≤?öË??öË?Ë®≠Â???,
      '?´Ê?': '?≤Áñ´/?´Á?È°åÊ??áÊ∫´ÔºåË??ëÂèØ?ΩÊ??ëÁ??Ä?´Á??áÈò≤?´È?',
      '?∞Ëó•?üÊ?': '?∞Ëó•/?®Â?È°åÊ??áÊ∫´ÔºåË??ëÂèØ?ΩÊ??ëÁ??Ä?áÈÜ´?•È?',
      'ËªçÂ∑•?∞Á∑£': '?∞Á∑£È¢®Èö™È°åÊ??áÊ∫´ÔºåË??ëÂèØ?ΩÊ??ëË?Â∑?ÂÆâÊéß/Ë≥áÂ???,
      '?ΩÊ??üÁâ©??: '?ΩÊ??áÂ??©Ê?È°åÊ??áÊ∫´ÔºåË??ëÂèØ?ΩÊ??ë‰?Ê∏∏Ë??ø‰ª£?ΩÊ???,
      '‰æõÊ???: '‰æõÊ??àÈ?ÁµÑÈ??êÂ?Ê∫´Ô?Ë≥áÈ??ØËÉΩÊµÅÂ??ø‰ª£‰æõÊ??áÂú®?∞Â???,
      '?øÁ??©Á?': '?øÁ?/?©Á?È°åÊ??áÊ∫´ÔºåÈ??çË??øÁ??óÊ??èÁæ§ËºÉÊ??óÈ?Ê≥?,
    };

    final topicSectorKeywords = <String, List<String>>{
      'AI': <String>['?ªÂ?', '?äÂ?È´?, '?öË?'],
      '‰ΩéË?Ë°õÊ?': <String>['?öË?', '?ªÂ?'],
      '?´Ê?': <String>['È£üÂ?', 'Â°ëÂ?'],
      '?∞Ëó•?üÊ?': <String>['È£üÂ?', 'Â°ëÂ?'],
      'ËªçÂ∑•?∞Á∑£': <String>['?ªÂ?', '?öË?'],
      '?ΩÊ??üÁâ©??: <String>['È£üÂ?', 'Â°ëÂ?', '?ºÈêµ'],
      '‰æõÊ???: <String>['?ºÈêµ', '?ªÂ?'],
      '?øÁ??©Á?': <String>['?ëË?'],
    };
    ...
    switch (entrySignal.type) {
      case _EntrySignalType.strong:
        reasons.add(
          '?ÄË°ìÈù¢ÔºöÂ???$score ?îÂº∑?¢È?Ê™?${strongScoreThreshold.toStringAsFixed(0)}Ôºå‰?Êº≤Â? ${stock.change.toStringAsFixed(2)}% ??${strongMinChange.toStringAsFixed(2)}%',
        );
        reasons.add(
          '?èÂÉπ?¢Ô??ê‰∫§??${_formatWithThousandsSeparator(stock.volume)} È´òÊñºÂº∑Âã¢?èÈ?Ê™?${_formatWithThousandsSeparator(strongVolumeThreshold.round())}',
        );
        break;
      case _EntrySignalType.watch:
        reasons.add(
          '?ÄË°ìÈù¢ÔºöÂ???$score Â∑≤È??ØË?ÂØüÈ?Ê™?$effectiveMinScoreÔºåÂÉπ?ºÁ∂≠?Å‰?Êº≤Ô?${stock.change.toStringAsFixed(2)}%Ôº?,
        );
        reasons.add('ÁØÄÂ•èÈù¢ÔºöÁõÆ?çÂ??åÂ?ËßÄÂØü„ÄÅÁ?Âª∂Á??çËÄåÈ?ËøΩÂÉπ');
        break;
      case _EntrySignalType.wait:
        reasons.add('Ë®äË??Ä?ãÔ??ÆÂ??èÁ?ÂæÖÔ?Âª∫Ë≠∞Á≠âÈ??πÂ?Á¢∫Ë?ÂæåÂ??≤Â†¥');
        break;
      case _EntrySignalType.avoid:
        reasons.add('Ë®äË??Ä?ãÔ??ÆÂ??èÈÅø?çËøΩÈ´òÔ??àÁ?È¢®Èö™?çÊ∫´ËºÉÁ©©??);
        break;
      case _EntrySignalType.neutral:
        reasons.add('Ë®äË??Ä?ãÔ??ÆÂ??™Â??®ÈÄ≤Â†¥ÁØ©ÈÅ∏ÔºåÂª∫Ë≠∞Â??ãÈ¢®?™ÊéßÁÆ°Ë®≠ÂÆ?);
        break;
    }

    reasons.add(
      '?ãÊ??¢Ô?$modeLabelÔº?{modeNarrative(matchedModes.isEmpty ? BreakoutMode : matchedModes.first)}',
    );
    reasons.add(
      '?∫Êú¨?¢Â?ÔºöÈ??ΩÈ?Ê®ôÔ?${_formatWithThousandsSeparator(stock.volume)} ??${_formatWithThousandsSeparator(effectiveVolumeThreshold)}Ôº?,
    );

    final sectorBonus = _sectorRotationBonus(stock);
    if (sectorBonus > 0) {
      reasons.add('?øÂ??¢Ô?$sectorÔºàËº™?ïÂ???+$sectorBonusÔºâÔ?${sectorNarrative(sector)}');
    } else {
      reasons.add('?øÂ??¢Ô?$sectorÔº?{sectorNarrative(sector)}');
    }
    ...
    if (matchedTopic.tag.isNotEmpty) {
      reasons.add(
        'È°åÊ??¢Ô?${topicNarrativeByTag[matchedTopic.tag] ?? '‰∏ªÈ?Ë≥áÈ?Ëº™Â??èÂº∑'}Ôº?{matchedTopic.tag} Âº∑Â∫¶ ${matchedTopic.score}Ôº?,
      );
    } else {
      final topTopic =
      ...
      if (topTopic.score >= 30) {
        reasons.add(
          'È°åÊ??¢Ô??ÆÂ??§Èù¢‰∏ªÈ??è„Ä?{topTopic.tag}?çÔ?Âº∑Â∫¶ ${topTopic.score}ÔºâÔ?‰ΩÜË?Ê≠§ËÇ°?úËÅØÂ∫¶ÊôÆ?öÔ?Âª∫Ë≠∞‰øùÂ??ÜÊâπ',
        );
      }
    }
    ...
    if (revenueMomentumScore != null) {
      final momentumText = revenueMomentumScore >= 2
          ? '?èÂº∑'
          : (revenueMomentumScore >= 0 ? '‰∏≠ÊÄ? : '?èÂº±');
      reasons.add('?üÊî∂?ïËÉΩÔº?momentumTextÔºàÂ???$revenueMomentumScoreÔº?);
    }

    if (earningsSurpriseScore != null) {
      final surpriseText = earningsSurpriseScore >= 2
          ? '?èÊ≠£??
          : (earningsSurpriseScore >= 0 ? '‰∏≠ÊÄ? : '?èË???);
      reasons.add('Ë≤°Â†± surpriseÔº?surpriseTextÔºàÂ???$earningsSurpriseScoreÔº?);
    }
    ...
    if (nearestEventWindowDays != null) {
      final eventText = nearestEventWindowDays >= 0
          ...
          : 'D+${nearestEventWindowDays.abs()}';
      reasons.add('Ê≥ïË™™/Ë≤°Â†±‰∫ã‰ª∂Á™óÔ?$eventText');
    }
  ...
  String _premarketRiskTypeLabel(_PremarketRiskType type) {
    return switch (type) {
      _PremarketRiskType.high => 'È´?,
      _PremarketRiskType.medium => '‰∏?,
      _PremarketRiskType.low => '‰Ω?,
    };
  }
  ...
  String _decisionSummaryFor(
    ...
    final riskTail = switch (riskType) {
      _PremarketRiskType.high => 'ÔºàÁõ§?çÈ¢®?™È?ÔºåÂö¥?ßÂÄâ‰?Ôº?,
      _PremarketRiskType.medium => 'ÔºàÁõ§?çÈ¢®?™‰∏≠ÔºåÂ??πË?‰Ω≥Ô?',
      _PremarketRiskType.low => '',
    };

    return switch (signalType) {
      _EntrySignalType.strong => '?ØÂ??âË©¶??riskTail',
      _EntrySignalType.watch => '?àË?ÂØüÔ?Á≠âÁ?Âº∑Â???riskTail',
      _EntrySignalType.wait => '?àÁ?Ë®äË?Á¢∫Ë?$riskTail',
      _EntrySignalType.avoid => '?àÈÅø?ãÔ?‰∏çËøΩ??riskTail',
      _EntrySignalType.neutral => '?àÁ?È¢®Èö™Ë®≠Â??çÊ±∫Á≠?riskTail',
    };
  }
  ...
  Future<void> _openRiskReductionSuggestionsDialog({
    ...
    if (candidates.isEmpty) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('?ÆÂ?Ê≤íÊ??ØÊ?‰æõÈ??âÂª∫Ë≠∞Á?È´?‰∏≠È¢®?™Ê???)),
      );
      return;
    }
    ...
    await showDialog<void>(
      ...
      builder: (dialogContext) {
        return AlertDialog(
          title: const Text('È´?‰∏≠È¢®?™Ê??°È??âÂª∫Ë≠?),
          content: SizedBox(
            width: 520,
            child: Column(
              mainAxisSize: MainAxisSize.min,
              ...
              children: [
                Text(
                  'Âª∫Ë≠∞Ë¶èÂ?ÔºöÈ?È¢®Èö™‰øùÁ? 50%?Å‰∏≠È¢®Èö™‰øùÁ? 75%ÔºàÂ??êÁ§∫Ôºå‰??ÉËá™?ïÊîπ?ïÂ∫´Â≠òÔ?',
                  style: Theme.of(context).textTheme.bodySmall,
                ),
                const SizedBox(height: 6),
                Text(
                  'Âª∫Ë≠∞?àË??ØÂ?Ê∏õÁ¢º ${totalCloseLots.toStringAsFixed(totalCloseLots % 1 == 0 ? 0 : 2)} Âº?,
                  style: Theme.of(context).textTheme.labelSmall,
                ),
                const SizedBox(height: 8),
                Flexible(
                  child: ListView(
                    ...
                    children: candidates.map((row) {
                      ...
                      return ListTile(
                        ...
                        subtitle: Text(
                          'È¢®Èö™ ${_premarketRiskTypeLabel(row.premarketRiskType)}ÔΩúÁõÆ??${lots.toStringAsFixed(lots % 1 == 0 ? 0 : 2)} ÂºµÔ?Âª∫Ë≠∞?àÊ?Á¢?$closeRatioTextÔºàÁ? $closeLots ÂºµÔ?‰øùÁ? $keepLots ÂºµÔ?\n'
                          '${row.entryPrice == null || row.closePrice == null ? '' : '?êÊú¨ ${row.entryPrice!.toStringAsFixed(2)} / ?æÂÉπ ${row.closePrice!.toStringAsFixed(2)}ÔΩ?}${row.decisionSummary}',
                        ),
                      );
                    }).toList(),
                  ),
          ...
          builder: (context, snapshot) {
            ...
            for (final item in candidateStocks) {
              ...
              if (_enableEventCalendarWindow &&
                ...
                if (days != null && days.abs() <= _eventCalendarGuardDays) {
                  markDrop(item.stock, 'Ê≥ïË™™/Ë≤°Â†±‰∫ã‰ª∂Á™?);
                  continue;
                }
              }
              if (_enableRevenueMomentumFilter) {
                ...
                if (momentum < _minRevenueMomentumScore) {
                  markDrop(item.stock, '?üÊî∂?ïËÉΩ?èÂº±');
                  continue;
                }
              }
              if (_enableEarningsSurpriseFilter) {
                ...
                if (surprise < _minEarningsSurpriseScore) {
                  markDrop(item.stock, 'Ë≤°Â†±È©öÂ?Â∫¶Â?Âº?);
                  continue;
                }
              }
              if (_isLikelyOvernightGapRisk(item.stock)) {
                markDrop(item.stock, '?îÊó•Ë∑≥Á©∫È¢®Èö™');
                continue;
              }
            ...
            String removedReasonHint(String code) {
              ...
              if (effectiveShowStrongOnly && !strongOnlyCodes.contains(code)) {
                return 'Âº∑Âã¢?êÂ?ÔºàÈ?Âº∑Âã¢Ë®äË?Ôº?;
              }
              if (_limitTopCandidates &&
                  searchedCodes.contains(code) &&
                  !limitedCodes.contains(code)) {
                return 'Ë∂ÖÂá∫??$_topCandidateLimit Ê™î‰???;
              }
              return '?íÂ?ËÆäÂ?ÔºàÁÑ°‰∏ªË??íÈô§Ê¢ù‰ª∂Ôº?;
            }
            ...
            String addedReasonHint(String code) {
              ...
              if (previousReasons.isNotEmpty) {
                return '?àÂ??óÈ?Ôº?{previousReasons.take(2).join('??)}';
              }
              if (_limitTopCandidates) {
                return '?àÂ??ØËÉΩ?óÂ? $_topCandidateLimit Ê™îÈ???;
              }
              return 'Ê¢ù‰ª∂ËΩâ‰Ω≥?ñÊ?Â∫èÂ?Áß?;
            }

            String reasonBucketLabel(String reason) {
              if (reason.startsWith('?àÂ??óÈ?Ôº?)) {
                final text = reason.substring('?àÂ??óÈ?Ôº?.length);
                return text.split('??).first;
              }
              return reason.split('Ôº?).first.split('??).first;
            }

            final removedReasonPreview = removedCodes
                .take(3)
                .map((code) => '$codeÔº?{removedReasonHint(code)}Ôº?)
                .toList();
            final addedReasonPreview = addedCodes
                .take(3)
                .map((code) => '$codeÔº?{addedReasonHint(code)}Ôº?)
                .toList();
            ...
            final sectorRegimeSummary = _sectorRegimeByGroup.entries
                ...
                .join(' / ');
            final scanSummary =
                '?ôÈÅ∏ ${limitedCandidateStocks.length} Ê™îÔ?Âº∑Âã¢ ${tagCounts[_EntrySignalType.strong] ?? 0} Ê™îÔ?ËßÄÂØ?${tagCounts[_EntrySignalType.watch] ?? 0} Ê™îÔ?Ê®°Â? ${BreakoutModeLabel(BreakoutMode)}ÔΩúÂØ¨Â∫?${marketBreadthRatio.toStringAsFixed(2)}ÔΩúRegime ${_regimeLabelOf(marketRegime)}ÔΩúÊùøÂ°?${sectorRegimeSummary.isEmpty ? '-' : sectorRegimeSummary}ÔΩúÈÄ?ôß $autoStreak Á≠?;
                                ...
                                children: [
                                  Row(
                                    children: [
                                      ...
                                      Text(
                                        '?ÅËÇ°Á∏ΩË¶ΩÔº?{filteredHoldingRows.length}/${holdingRows.length} Ê™îÔ?',
                                        style: Theme.of(context)
                                            .textTheme
                                            .titleSmall,
                                      ),
                                      ...
                                      if (holdingRows.isNotEmpty)
                                        Padding(
                                          ...
                                          child: Text(
                                            'È´òÈ¢®??$highRiskHoldingCountÔΩú‰∏≠È¢®Èö™ $mediumRiskHoldingCount',
                                            style: Theme.of(context)
                                                .textTheme
                                                .labelSmall,
                                          ),
                                      ...
                                      TextButton.icon(
                                        ...
                                        label: const Text('?çÂÄâÂª∫Ë≠?),
                                      ),
                                      TextButton.icon(
                                        onPressed: _openManualHoldingDialog,
                                        icon: const Icon(Icons.add),
                                        label: const Text('?∞Â?Â∫´Â?'),
                                      ),
                                    ],
                                  ),
                                  const SizedBox(height: 6),
                                  ...
                                  if (holdingRows.isEmpty)
                                    const Text('?ÆÂ?Â∞öÊú™Ë®≠Â?‰ªª‰??ÅËÇ°ÔºàÊ???ÂºµÊï∏Ôº?)
                                  else if (filteredHoldingRows.isEmpty)
                                    const Text('?ÆÂ?Ê≤íÊ?Á¨¶Â?ÁØ©ÈÅ∏Ê¢ù‰ª∂?ÑÊ???)
                                  else
                                    ...filteredHoldingRows.map(
                                      (row) => ListTile(
                                        ...
                                        title: Text('${row.code} ${row.name}'),
                                        subtitle: Text(
                                          '${row.entryPrice == null ? '?êÊú¨ -' : '?êÊú¨ ${row.entryPrice!.toStringAsFixed(2)}'}ÔΩ?
                                          '${row.lots == null ? 'ÂºµÊï∏ -' : 'ÂºµÊï∏ ${row.lots!.toStringAsFixed(row.lots! % 1 == 0 ? 0 : 2)}'}ÔΩ?
                                          '${row.closePrice == null ? '?æÂÉπ -' : '?æÂÉπ ${row.closePrice!.toStringAsFixed(2)}'}'
                                          '\n‰∏Ä?•Ë©±Ôº?{row.decisionSummary}'
                                          'ÔΩúË???${row.entrySignalLabel}'
                                          'ÔΩúÁõ§?çÈ¢®??${_premarketRiskTypeLabel(row.premarketRiskType)}'
                                          '${row.matchedModes.isEmpty ? '' : '\n?Ω‰∏≠Ê®°Â?Ôº?{row.matchedModes.take(3).map(BreakoutModeLabel).join(' / ')}${row.matchedModes.length > 3 ? ' +${row.matchedModes.length - 3}' : ''}'}',
                                        ),
                                        trailing: Row(
                                          mainAxisSize: MainAxisSize.min,
                                          children: [
                        ...
                        Padding(
                          ...
                          child: Card(
                            child: ExpansionTile(
                              ...
                              title: const Text('ÁØ©ÈÅ∏Ë®∫Êñ∑Ôºà‰??•Ë¢´?íÈô§‰∏ªÂ?Ôº?),
                              childrenPadding:
                        ...
                        Padding(
                          ...
                          child: Card(
                            child: ListTile(
                              ...
                              title: const Text('?ôÈÅ∏Á©©Â??ßÔ??¨Ê¨° vs ‰∏äÊ¨°Ôº?),
                              subtitle: !_hasLimitedCandidateSnapshot
                                  ? const Text('Â∞öÊú™Âª∫Á?ÊØîË?Âø´ÁÖß')
                                  : (driftBaselineReset
                                      ? Text(
                                          'Â∑≤È?ÁΩÆÊ?ËºÉÂü∫Ê∫ñÔ??∏Â??ÉÊï∏ËÆäÊõ¥ÔºâÔ??∏Â??ôÈÅ∏ ${qualityCodes.length} Ê™îÔ??´Èù¢È°ØÁ§∫ ${limitedCodes.length} Ê™î\n'
                                          'ËÆäÊõ¥Ôº?{changedFilterContextLabels.take(6).join('??)}${changedFilterContextLabels.length > 6 ? ' +${changedFilterContextLabels.length - 6}' : ''}')
                                      : !hasCandidateDrift
                                    ? Text(
                                      '?∏Â??ôÈÅ∏ ${qualityCodes.length} Ê™îÔ??á‰?Ê¨°Áõ∏?åÔ?ÔΩúÁï´?¢È°ØÁ§?${limitedCodes.length} Ê™?)
                                    : Text(
                                      '?∞Â? ${addedCodes.length}ÔΩúÁßª??${removedCodes.length}ÔΩúÊõ¥??${_formatTimeHHmm(DateTime.now())}\n'
                                      '?∞Â?Ôº?{addedCodes.isEmpty ? '-' : addedCodes.take(5).join('??)}\n'
                                      'ÁßªÈô§Ôº?{removedCodes.isEmpty ? '-' : removedCodes.take(5).join('??)}\n'
                                      '?∞Â?‰∏ªÂ?Ôº?{addedReasonPreview.isEmpty ? '-' : addedReasonPreview.join('??)}\n'
                                      'ÁßªÈô§‰∏ªÂ?Ôº?{removedReasonPreview.isEmpty ? '-' : removedReasonPreview.join('??)}\n'
                                      '?∏Â??ôÈÅ∏ ${qualityCodes.length} Ê™îÔ??´Èù¢È°ØÁ§∫ ${limitedCodes.length} Ê™?,
                                    )),
                              isThreeLine: true,
                          ...
                          Padding(
                            ...
                            child: Align(
                              ...
                              child: TextButton.icon(
                                ...
                                label: const Text('?ÑÂ?‰∏äÊ¨°ÊØîË??ÉÊï∏'),
                              ),
                            ),
                          ),
                          ...
                          Padding(
                            ...
                            child: Card(
                              child: ExpansionTile(
                                ...
                                title: const Text('ËÆäÂ??ÇÈ?Ëª∏Ô??ÄËø?8 Ê¨°Ô?'),
                          ...
                          Padding(
                            ...
                            child: Card(
                              child: ExpansionTile(
                                ...
                                title: const Text('?∏Â??ÉÊï∏ËÆäÊõ¥Á¥Ä?ÑÔ??ÄËø?8 Ê¨°Ô?'),
                                childrenPadding: const EdgeInsets.fromLTRB(
                                    12, 0, 12, 10),
                          ...
                          Padding(
                            ...
                            child: Card(
                              ...
                              child: const ListTile(
                                ...
                                title: Text('?∏ËÇ°?ÉÊï∏Â∑≤È?ÂÆ?),
                                subtitle: Text('?™Â?Ê®°Â??áÊ??á‰?‰ª∂Ê®°?øËá™?ïÂ??®Êö´??),
                              ),
                            ),
                          ),
                        Padding(
                          ...
                          child: Card(
                            child: ExpansionTile(
                              ...
                              title: const Text('Ë®äË??Ω‰∏≠ËøΩËπ§Ôº?/3/5?•Âπ≥?áÔ?'),
                              childrenPadding:
                                  const EdgeInsets.fromLTRB(12, 0, 12, 10),
                              children: [
                                Align(
                                  alignment: Alignment.centerLeft,
                                  child: Text(
                                    'Âº∑Âã¢Ôº?D ${strongPerf.day1Avg.toStringAsFixed(2)}% / ?ùÁ? ${strongPerf.day1WinRate.toStringAsFixed(1)}% / ?ûÊí§ ${strongPerf.day1MaxDrawdown.toStringAsFixed(2)}% (${strongPerf.day1Count})ÔΩ?D ${strongPerf.day3Avg.toStringAsFixed(2)}% / ?ùÁ? ${strongPerf.day3WinRate.toStringAsFixed(1)}% / ?ûÊí§ ${strongPerf.day3MaxDrawdown.toStringAsFixed(2)}% (${strongPerf.day3Count})ÔΩ?D ${strongPerf.day5Avg.toStringAsFixed(2)}% / ?ùÁ? ${strongPerf.day5WinRate.toStringAsFixed(1)}% / ?ûÊí§ ${strongPerf.day5MaxDrawdown.toStringAsFixed(2)}% (${strongPerf.day5Count})',
                                    style:
                                ...
                                Align(
                                  alignment: Alignment.centerLeft,
                                  child: Text(
                                    'ËßÄÂØüÔ?1D ${watchPerf.day1Avg.toStringAsFixed(2)}% / ?ùÁ? ${watchPerf.day1WinRate.toStringAsFixed(1)}% / ?ûÊí§ ${watchPerf.day1MaxDrawdown.toStringAsFixed(2)}% (${watchPerf.day1Count})ÔΩ?D ${watchPerf.day3Avg.toStringAsFixed(2)}% / ?ùÁ? ${watchPerf.day3WinRate.toStringAsFixed(1)}% / ?ûÊí§ ${watchPerf.day3MaxDrawdown.toStringAsFixed(2)}% (${watchPerf.day3Count})ÔΩ?D ${watchPerf.day5Avg.toStringAsFixed(2)}% / ?ùÁ? ${watchPerf.day5WinRate.toStringAsFixed(1)}% / ?ûÊí§ ${watchPerf.day5MaxDrawdown.toStringAsFixed(2)}% (${watchPerf.day5Count})',
                                    style:
                                        Theme.of(context).textTheme.bodySmall,
                                  ),
                                ),
                                ...
                                Align(
                                  alignment: Alignment.centerLeft,
                                  child: Text(
                                    '?êÁ?Â∫¶Ô??Ä?≥Â???1/3/5 ?ã‰∫§?ìÊó•?çÊ?Â°´ÂÖ•Â∞çÊ?Ê¨Ñ‰?ÔºõÊ®£?¨‰?Ë∂≥Ê??ÉÈ°ØÁ§?0??,
                                    style:
                        ...
                        Padding(
                          ...
                          child: Card(
                            child: ListTile(
                              ...
                              title: const Text('ÊØèÈÄ±ÂëΩ‰∏≠Á??òË?ÔºàÊ?Ëø?7 Â§©Ô?'),
                        ...
                        Padding(
                          ...
                          child: Align(
                            ...
                            child: TextButton.icon(
                              ...
                              label: const Text('?Ω‰∏≠?áËá™?ïË™ø?ÉÂª∫Ë≠?),
                            ),
                          ),
                        ),
                        Padding(
                          ...
                          child: Card(
                            child: ListTile(
                              ...
                              title: Text(
                                'È¢®Èö™?ÜÊï∏ ${riskSnapshot.score}ÔΩ?{riskSnapshot.level}',
                              ),
                              subtitle: Text(
                                _enableAutoRiskAdjustment
                                    ? (_autoRiskAdjustmentSuppressedReason() ==
                                            null
                                        ? 'Â∑≤Â??®Ëá™?ïË™ø?ÉÔ?Âº∑Â∫¶ ${_autoRiskAdjustmentStrength} ${_riskAdjustmentIntensityLabel()}ÔºâÔ??ÜÊï∏?ÄÊ™?${_riskScoreBias(riskSnapshot) >= 0 ? '+' : ''}${_riskScoreBias(riskSnapshot)}?ÅÈ???x${_riskVolumeMultiplier(riskSnapshot).toStringAsFixed(2)}?ÅÂ???x${_riskTakeProfitMultiplier(riskSnapshot).toStringAsFixed(2)}ÔΩúË?7??${_riskScoreTrendText()}'
                                        : 'Â∑≤Â??®Ëá™?ïË™ø?ÉÔ?‰ΩÜÁõÆ?çÁÇ∫${_autoRiskAdjustmentSuppressedReason()}ÔΩúË?7??${_riskScoreTrendText()}')
                                    : '?™Â?Ë™øÂ?Â∑≤È??âÔ?‰ΩøÁî®?∫Â??ÉÊï∏Ôº?,
                              ),
                            ),
                          ),
                        ),
                                ...
                                children: [
                                  Row(
                                    children: [
                                      ...
                                      Expanded(
                                        child: Text(
                                          '$recommendationSessionLabelÂª∫Ë≠∞Ê®°Â?Ôº?{BreakoutModeLabel(modeRecommendation.mode)}',
                                          style: Theme.of(context)
                                              .textTheme
                                              .titleSmall,
                                        ),
                                      ...
                                      if (BreakoutMode !=
                                        ...
                                        FilledButton.tonal(
                                          ...
                                          child: const Text('Â•óÁî®Âª∫Ë≠∞'),
                                        )
                                      else
                                        const Chip(label: Text('Â∑≤Â???)),
                                    ],
                                  ),
                                  const SizedBox(height: 4),
                                  Text(
                                  ...
                                  if (suggestedEventTemplate != null) ...[
                                    ...
                                    Align(
                                      alignment: Alignment.centerLeft,
                                      child: Text(
                                        '?∞Ë?‰∫ã‰ª∂?§Ë?Ôº?{suggestedEventTemplate.label}Ôº?{suggestedEventTemplate.adjustmentSummary}Ôº?,
                                        style: Theme.of(context)
                                            .textTheme
                                            .bodySmall,
                                      ),
                                    ...
                                    Align(
                                      ...
                                      child: FilledButton.tonalIcon(
                                        ...
                                        label: Text(
                                            'Â•óÁî®${suggestedEventTemplate.label}'),
                                      ),
                                    ),
                                  ],
                                  if (_hasNewsEventTuneBackup()) ...[
                                      ...
                                      child: TextButton.icon(
                                        ...
                                        label: Text(
                                          activeEventTemplate == null
                                              ? '?ÑÂ?‰∫ã‰ª∂?çÂ???
                                              : '?ÑÂ?${activeEventTemplate.label}?çÂ???,
                                        ),
                                      ),
                                    ),
                                    if (_autoApplyNewsEventTemplate &&
                                      ...
                                      Padding(
                                        ...
                                        child: Text(
                                          '?™Â??ÑÂ??íÊï∏Ôº?eventTemplateAutoRestoreDaysLeft Â§©Ô??°‰?‰ª∂ÂëΩ‰∏≠Ô?',
                                          style: Theme.of(context)
                                              .textTheme
                                              .labelSmall,
                                        ),
                            ...
                            child: Wrap(
                              ...
                              children: [
                                ...
                                if (_showStrongOnly && !_enableScoring)
                                  const Chip(
                                    label: Text('Âº∑Âã¢?êÂ?ÔºàÈ??üÁî®?ìÂ?Ôº?),
                                    visualDensity: VisualDensity.compact,
                                  ),
                              ],
                            ),
                    ...
                    SliverFillRemaining(
                      ...
                      child: Padding(
                        ...
                        child: Center(
                          child: Text(
                            _showOnlyFavorites
                                ? '?∂Ë??çÂñÆ?ÆÂ?Ê≤íÊ?Á¨¶Â?Ê¢ù‰ª∂?ÑËÇ°Á•?
                                : (_showOnlyHoldings
                                    ? '?ÅËÇ°Ê∏ÖÂñÆ?ÆÂ?Ê≤íÊ?Á¨¶Â?Ê¢ù‰ª∂?ÑËÇ°Á•?
                                    : '?ÆÂ?Ê≤íÊ?Á¨¶Â?Ê¢ù‰ª∂?ÑËÇ°Á•®Ë???),
                          ),
                        ),
                      ),
                    )
...
class _StockCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final estimateScopeLabel = lots == null
        ? 'ÔºàÊ? 1 Âºµ‰º∞ÁÆóÔ?'
        : 'Ôºà‰??ÆÂ?ÂºµÊï∏ ${estimateLots.toStringAsFixed(estimateLots % 1 == 0 ? 0 : 2)}Ôº?;
    ...
    final (decisionText, decisionBg, decisionFg) = switch (entrySignal.type) {
      _EntrySignalType.strong => (
          '‰∏Ä?•Ë©±ÔºöÂèØÂ∞èÂÄâË©¶??riskTail',
          Colors.red,
          Colors.white
        ),
      _EntrySignalType.watch => (
          '‰∏Ä?•Ë©±ÔºöÂ?ËßÄÂØüÔ?Á≠âÁ?Âº∑Â???riskTail',
          scheme.secondaryContainer,
          scheme.onSecondaryContainer,
        ),
      _EntrySignalType.wait => (
          '‰∏Ä?•Ë©±ÔºöÂ?Á≠âË??üÁ¢∫Ë™?riskTail',
          scheme.tertiaryContainer,
          scheme.onTertiaryContainer,
        ),
      _EntrySignalType.avoid => (
          '‰∏Ä?•Ë©±ÔºöÂ??øÈ?Ôºå‰?ËøΩÂÉπ$riskTail',
          Colors.orange,
          Colors.white
        ),
      _EntrySignalType.neutral => (
          '‰∏Ä?•Ë©±ÔºöÂ??ãÈ¢®?™Ë®≠ÂÆöÂ?Ê±∫Á?$riskTail',
                                      ...
                                      children: [
                                        if (bullishRationales.isNotEmpty) ...[
                                          ...
                                          Align(
                                            ...
                                            child: Text(
                                              entrySignal.type ==
                                                      _EntrySignalType.strong
                                                  ? 'Âº∑Âã¢‰æùÊ?Ôº?{bullishRationales.join('ÔΩ?)}'
                                                  : '?≤Â†¥‰æùÊ?Ôº?{bullishRationales.join('ÔΩ?)}',
                                              style: Theme.of(context)
                                                  .textTheme
                                                  .bodySmall,
                                            ),
                                          ...
                                          Align(
                                            alignment: Alignment.centerLeft,
                                            child: Text(
                                              '?êÈ?ÔºöÊ≠§?∫Ê?‰ª∂ÂëΩ‰∏≠Ë™™?éÔ??û‰?Ë≠â‰?Êº≤Ô?Ë´ãÊê≠?çÂ??çÊéßÁÆ°„Ä?,
                                              style: Theme.of(context)
                                                  .textTheme
                                                  .labelSmall,
                                            ),
                                        ...
                                        if (showOpenConfirmHint) ...[
                                          ...
                                          Align(
                                            alignment: Alignment.centerLeft,
                                            child: Text(
                                              '?ÇÊÆµ?êÈ?Ôº?marketTimingStatusLabelÔº?9:30 ÂæåÂ?Á¢∫Ë?Ôº?,
                                              style: Theme.of(context)
                                                  .textTheme
                                                  .bodySmall,
                                            ),
                                        ...
                                        const SizedBox(height: 6),
                                        // ÁæéÂ?ÂæåÁ?Ë®∫Êñ∑?±Â?È°ØÁ§∫ÔºàËã•??scoreÔº?
                                        if (score != null) ...[
                                          Container(
                                            width: double.infinity,
                                            padding: const EdgeInsets.all(10),
                                    ...
                                    child: ExpansionTile(
                                      ...
                                      children: [
                                        Align(
                                          ...
                                          child: Text(
                                            entryPrice == null ||
                                                    pnlPercent == null ||
                                                    lots == null
                                                ? '?™Ë®≠ÂÆöÊ??°Ô??êÊú¨/ÂºµÊï∏Ôº?
                                                : '?êÊú¨ ${entryPrice!.toStringAsFixed(2)}  ÂºµÊï∏ ${lots!.toStringAsFixed(lots! % 1 == 0 ? 0 : 2)}  ?çÁ? ${pnlPercent! >= 0 ? '+' : ''}${pnlPercent!.toStringAsFixed(2)}%${pnlAmount == null ? '' : ' (${pnlAmount! >= 0 ? '+' : ''}${_formatCurrency(pnlAmount!)})'}',
                                            style: Theme.of(context)
                                                .textTheme
                                                .bodySmall,
                                          ),
                                        ...
                                        Align(
                                          alignment: Alignment.centerLeft,
                                          child: Text(
                                            'Âª∫Ë≠∞?≤Â†¥ ‰øùÂ? ${entryPlan.conservativeEntry.toStringAsFixed(2)} / Á©çÊ•µ ${entryPlan.aggressiveEntry.toStringAsFixed(2)}',
                                            style: Theme.of(context)
                                                .textTheme
                                                .bodySmall,
                                          ),
                                        ...
                                        Align(
                                          alignment: Alignment.centerLeft,
                                          child: Text(
                                            '?≤ËøΩÈ´òÂ???> ${entryPlan.avoidAbovePrice.toStringAsFixed(2)}',
                                            style: Theme.of(context)
                                                .textTheme
                                                .bodySmall,
                                          ),
                                        ...
                                        Align(
                                          alignment: Alignment.centerLeft,
                                          child: Text(
                                            '?∫Â†¥Ë¶èÂ? ?úÊ? ${entryPlan.stopLossPrice.toStringAsFixed(2)} / ?úÂà© ${entryPlan.takeProfitPrice.toStringAsFixed(2)}',
                                            style: Theme.of(context)
                                                .textTheme
                                                .bodySmall,
                                          ),
                                        ...
                                        Align(
                                          alignment: Alignment.centerLeft,
                                          child: Text(
                                            '‰øùÂ?‰º∞Á?$estimateScopeLabel ?ÆÊ? ${conservativeTargetSpacePercent >= 0 ? '+' : ''}${conservativeTargetSpacePercent.toStringAsFixed(2)}%ÔΩúÈ¢®??-${conservativeRiskSpacePercent.abs().toStringAsFixed(2)}%ÔΩúR ${conservativeR == null ? '-' : conservativeR.toStringAsFixed(2)}',
                                            style: Theme.of(context)
                                                .textTheme
                                                .bodySmall
                                                ?.copyWith(
                                        ...
                                        Align(
                                          alignment: Alignment.centerLeft,
                                          child: Text(
                                            '‰øùÂ??ëÈ? ?úÂà© ${conservativeEstimatedProfitAmount >= 0 ? '+' : ''}${_formatCurrency(conservativeEstimatedProfitAmount)} / ?úÊ? -${_formatCurrency(conservativeEstimatedLossAmount.abs())}',
                                            style: Theme.of(context)
                                                .textTheme
                                                .bodySmall
                                                ?.copyWith(
                                          ...
                                          child: ExpansionTile(
                                            ...
                                            children: [
                                              Align(
                                                alignment: Alignment.centerLeft,
                                                child: Text(
                                                  'Á©çÊ•µ‰º∞Á?$estimateScopeLabel ?ÆÊ? ${aggressiveTargetSpacePercent >= 0 ? '+' : ''}${aggressiveTargetSpacePercent.toStringAsFixed(2)}%ÔΩúÈ¢®??-${aggressiveRiskSpacePercent.abs().toStringAsFixed(2)}%ÔΩúR ${aggressiveR == null ? '-' : aggressiveR.toStringAsFixed(2)}',
                                                  style: Theme.of(context)
                                                      .textTheme
                                                      .bodySmall
                                                      ?.copyWith(
                                              ...
                                              Align(
                                                alignment: Alignment.centerLeft,
                                                child: Text(
                                                  'Á©çÊ•µ?ëÈ? ?úÂà© ${aggressiveEstimatedProfitAmount >= 0 ? '+' : ''}${_formatCurrency(aggressiveEstimatedProfitAmount)} / ?úÊ? -${_formatCurrency(aggressiveEstimatedLossAmount.abs())}',
                                                  style: Theme.of(context)
                                                      .textTheme
                                                      .bodySmall
                                                      ?.copyWith(
                                        ...
                                        Align(
                                          alignment: Alignment.centerLeft,
                                          child: Text(
                                            '?ê‰∫§??${_formatCurrency(stock.tradeValue)}',
                                            style: Theme.of(context)
                                                .textTheme
                                                .bodySmall,
                                          ),
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            ...
            const SizedBox(width: 8),
            Text(
              autoRefreshEnabled ? 'ÊØ?${autoRefreshMinutes} ?? : '?ãÂ??¥Êñ∞',
...
class _MarketNewsCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
        ...
        child: Padding(
          ...
          child: Row(
            children: [
              ...
              SizedBox(width: 10),
              Expanded(child: Text('?∞Ë?È¢®Èö™?ÜÊ??¥Êñ∞‰∏?..')),
            ],
          ),
        ),
      );
    ...
    final (background, foreground, label) = switch (data.level) {
      NewsRiskLevel.high => (Colors.red, Colors.white, '?èÈ?'),
      NewsRiskLevel.medium => (Colors.orange, Colors.white, '‰∏≠Á?'),
      NewsRiskLevel.low => (Colors.teal, Colors.white, '?è‰?'),
    };
          ...
          children: [
            Row(
              children: [
                Container(
                  ...
                  child: Text(
                    '?∞Ë?È¢®Èö™Ôº?label (${data.riskScore})',
                    style: Theme.of(context).textTheme.labelMedium?.copyWith(
                          color: foreground,
                          fontWeight: FontWeight.w600,
                        ),
            ...
            Theme(
              ...
              child: ExpansionTile(
                ...
                childrenPadding: EdgeInsets.zero,
                title: Text(
                  '?•Á??∞Ë??éÁ¥∞${topNews.isEmpty ? '' : 'Ôº?{topNews.length} ?áÔ?'}',
                ...
                children: [
                  Text(
                    autoDefensiveOnHighNewsRisk
                        ? (isHighNewsRiskDefenseActive
                            ? '?çÂ§ß‰∫ã‰ª∂Ê®°Â?ÔºöÂ∑≤?üÂ?‰øùÂ?Á≠ñÁï•'
                            : '?çÂ§ß‰∫ã‰ª∂Ê®°Â?ÔºöÂ∑≤?üÁî®ÔºàÈ?È¢®Èö™?ÇËá™?ïÂ?‰øùÂ?Ôº?)
                        : '?çÂ§ß‰∫ã‰ª∂Ê®°Â?ÔºöÂ∑≤?úÈ?',
                    style: Theme.of(context).textTheme.bodySmall,
                  ),
                  const SizedBox(height: 6),
                  Align(
                    alignment: Alignment.centerLeft,
                    child: Text(
                      '?¥Êñ∞?ÇÈ?Ôº?{_formatNewsTime(data.asOf)}',
                      style: Theme.of(context).textTheme.labelSmall,
                    ),
                  ),
                  if (topNews.isNotEmpty) ...[
                    ...
                    ...topNews.map(
                      (news) => ListTile(
                        ...
                        subtitle: Text(
                          '${news.source}ÔΩ?{_formatNewsTime(news.publishedAt)}',
                        ),
...
String _formatNewsTime(DateTime? time) {
  ...
  if (diff.inMinutes < 60) {
    return '${diff.inMinutes} ?ÜÈ???;
  }
  if (diff.inHours < 24) {
    return '${diff.inHours} Â∞èÊ???;
  }
  return '${time.month.toString().padLeft(2, '0')}/${time.day.toString().padLeft(2, '0')} ${time.hour.toString().padLeft(2, '0')}:${time.minute.toString().padLeft(2, '0')}';
}
        ...
        child: Column(
          ...
          children: [
            ...
            Wrap(
              ...
              runSpacing: 6,
              children: const [
                _LegendTag(text: '?≤Â†¥ÔºöÂº∑?¢ÈÄ≤Â†¥', bgColor: Colors.red),
                _LegendTag(text: '?≤Â†¥ÔºöË?ÂØüÈÄ≤Â†¥', bgColor: Colors.blue),
                _LegendTag(text: '?≤Â†¥ÔºöÁ?ÂæÖË???, bgColor: Colors.teal),
                _LegendTag(text: '?≤Â†¥ÔºöÈÅø?çËøΩÈ´?, bgColor: Colors.orange),
                _LegendTag(text: '?≤Â†¥ÔºöÊú™?üÁî®', bgColor: Colors.grey),
                _LegendTag(text: '?∫Â†¥ÔºöÂ??çË≠¶Á§?, bgColor: Colors.red),
                _LegendTag(text: '?∫Â†¥ÔºöÂ??πÂ???, bgColor: Colors.indigo),
                _LegendTag(text: '?∫Â†¥ÔºöÁ??±Ë?ÂØ?, bgColor: Colors.teal),
              ],
            ),
          ],
        ),
        ...
        children: [
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 8),
                    Text('?ùÁ? ${winRate.toStringAsFixed(1)}%Ôº?winCount/$totalÔº?),
                    Text(
                        'Âπ≥Â??±ÈÖ¨ ${avgPnlPercent >= 0 ? '+' : ''}${avgPnlPercent.toStringAsFixed(2)}%'),
                    Text(
                        'Âπ≥Â??çÁ? ${avgPnlAmount >= 0 ? '+' : ''}${_formatCurrency(avgPnlAmount)}'),
                    Text(
                        'Á∏ΩÊ???${totalPnlAmount >= 0 ? '+' : ''}${_formatCurrency(totalPnlAmount)}'),
                    const SizedBox(height: 6),
                    Text(
                      'A Á≠ñÁï•Ôº?{statsA.count} Á≠ÜÔ??ùÁ? ${statsA.winRate.toStringAsFixed(1)}%ÔΩúÂ??±ÈÖ¨ ${statsA.avgPnlPercent >= 0 ? '+' : ''}${statsA.avgPnlPercent.toStringAsFixed(2)}%',
                    ),
                    Text(
                      'B Á≠ñÁï•Ôº?{statsB.count} Á≠ÜÔ??ùÁ? ${statsB.winRate.toStringAsFixed(1)}%ÔΩúÂ??±ÈÖ¨ ${statsB.avgPnlPercent >= 0 ? '+' : ''}${statsB.avgPnlPercent.toStringAsFixed(2)}%',
                    ),
                  ],
                ),
              ),
          ...
          Expanded(
            child: visible.isEmpty
                ? const Center(child: Text('Ê≤íÊ??ØÈ°ØÁ§∫Á?‰∫§Ê?Á¥Ä??))
                : ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Card(
                        child: ListTile(
                          ...
                          subtitle: Text(
                              '$timeTextÔΩúÁ???{item.strategyTag}ÔΩ?{item.reason}'),
                          trailing: Column(
